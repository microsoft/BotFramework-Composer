...
***[ add image here of property in BF Composer ]***
* `user.name`
* `turn.activity`
* `dialog.index`
* `user.profile.age`
...
![Prompt definition](./existingdocs/Assets/prompt-property.png)
...
![Sampple dialog](./existingdocs/Assets/dialog-with-return.png)
...
![Branch condition](./existingdocs/Assets/branch-condition.png)
...
![use a property in the message text](./existingdocs/Assets/lg-properties.png)
