...
```
 ...
 If you are having trouble intalling or building Composer run `yarn tableflip`, and then run `yarn install` and `yarn build` again. This process can take anywhere from 5-10 minutes.
