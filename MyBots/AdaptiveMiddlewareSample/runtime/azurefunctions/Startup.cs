    ...
    public class Startup : FunctionsStartup
    {
        ...
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            services.AddSingleton<IBotFrameworkHttpAdapter, BotFrameworkHttpAdapter>(s =>
            {
                ...
                ConfigureAdaptiveMiddleware(adapter, settings, s);
        ...
        public void ConfigureAdaptiveMiddleware(BotFrameworkAdapter adapter, BotSettings settings, IServiceProvider sp)
        {
            if (settings?.MiddlewareDialogs?.Length > 0)
            {
                ...
                foreach (var dialogName in settings.MiddlewareDialogs)
                {
                    adapter.Use(new AdaptiveMiddlware(dialogName, defaultLocale, conversationState, userState, resourceExplorer, telemetryClient));
                }
            }
        }
