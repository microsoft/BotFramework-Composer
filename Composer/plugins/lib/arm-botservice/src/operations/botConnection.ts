...
export class BotConnection {
  ...
  listServiceProviders(
    options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ServiceProviderResponseList>,
    callback?: msRest.ServiceCallback<Models.ServiceProviderResponseList>
  ...
  listByBotService(
    resourceGroupName: string,
    resourceName: string,
    options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ConnectionSettingResponseList>,
    callback?: msRest.ServiceCallback<Models.ConnectionSettingResponseList>
  ): Promise<Models.BotConnectionListByBotServiceResponse> {
    return this.client.sendOperationRequest(
      {
