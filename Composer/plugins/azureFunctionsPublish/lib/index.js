...
const bot_deploy_1 = require("@bfc/libs/bot-deploy");
...
class AzurePublisher {
    constructor() {
        ...
        this.createAndDeploy = (botId, profileName, jobId, resourcekey, customizeConfiguration) => __awaiter(this, void 0, void 0, function* () {
            const { name, environment, hostname, luisResource, language } = customizeConfiguration;
            try {
                // Perform the deploy
                yield this.azDeployer.deploy(name, environment, null, null, null, language, hostname, luisResource);
        ...
        this.publish = (config, project, metadata, user) => __awaiter(this, void 0, void 0, function* () {
            ...
            const { fullSettings, templatePath, profileName, subscriptionID, name, environment, hostname, luisResource, language, settings, accessToken, } = config;
            ...
            try {
                ...
                if (!settings) {
                    throw new Error('no successful created resource in Azure according to your config, please run provision script included in your bot project.');
                }
                ...
                const resourcePath = path_1.default.resolve(this.getProjectFolder(resourcekey, DEFAULT_RUNTIME), 'appsettings.deployment.json');
                ...
                this.azDeployer = new bot_deploy_1.BotProjectDeploy({
                    ...
                    dotnetProjectPath: path_1.default.join(this.getProjectFolder(resourcekey, DEFAULT_RUNTIME), 'Microsoft.BotFramework.Composer.Functions.csproj'),
                });
