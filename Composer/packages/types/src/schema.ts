...
export enum SDKKinds {
  ...
  /** Teams Triggers */
  OnTeamsAppBasedLinkQuery = 'Microsoft.OnTeamsAppBasedLinkQuery',
  OnTeamsCardAction = 'Microsoft.OnTeamsCardAction',
  OnTeamsChannelCreated = 'Microsoft.OnTeamsChannelCreated',
  OnTeamsChannelDeleted = 'Microsoft.OnTeamsChannelDeleted',
  OnTeamsChannelRenamed = 'Microsoft.OnTeamsChannelRenamed',
  OnTeamsChannelRestored = 'Microsoft.OnTeamsChannelRestored',
  OnTeamsFileConsent = 'Microsoft.OnTeamsFileConsent',
  OnTeamsMessagingExtensionCardButtonClicked = 'Microsoft.OnTeamsMessagingExtensionCardButtonClicked',
  OnTeamsMessagingExtensionConfigurationQuerySettingUrl = 'Microsoft.OnTeamsMessagingExtensionConfigurationQuerySettingUrl',
  OnTeamsMessagingExtensionConfigurationSetting = 'Microsoft.OnTeamsMessagingExtensionConfigurationSetting',
  OnTeamsMessagingExtensionFetchTask = 'Microsoft.OnTeamsMessagingExtensionFetchTask',
  OnTeamsMessagingExtensionQuery = 'Microsoft.OnTeamsMessagingExtensionQuery',
  OnTeamsMessagingExtensionSelectItem = 'Microsoft.OnTeamsMessagingExtensionSelectItem',
  OnTeamsMessagingExtensionSubmitAction = 'Microsoft.OnTeamsMessagingExtensionSubmitAction',
  OnTeamsO365ConnectorCardAction = 'Microsoft.OnTeamsO365ConnectorCardAction',
  OnTeamsTaskModuleFetch = 'Microsoft.OnTeamsTaskModuleFetch',
  OnTeamsTaskModuleSubmit = 'Microsoft.OnTeamsTaskModuleSubmit',
  OnTeamsTeamArchived = 'Microsoft.OnTeamsTeamArchived',
  OnTeamsTeamDeleted = 'Microsoft.OnTeamsTeamDeleted',
  OnTeamsTeamHardDeleted = 'Microsoft.OnTeamsTeamHardDeleted',
  OnTeamsTeamRenamed = 'Microsoft.OnTeamsTeamRenamed',
  OnTeamsTeamRestored = 'Microsoft.OnTeamsTeamRestored',
  OnTeamsTeamUnarchived = 'Microsoft.OnTeamsTeamUnarchived',
  OnTeamsMessagingExtensionBotMessagePreviewEdit = 'Microsoft.OnTeamsMessagingExtensionBotMessagePreviewEdit',
  OnTeamsMessagingExtensionBotMessagePreviewSend = 'Microsoft.OnTeamsMessagingExtensionBotMessagePreviewSend',
  OnTeamsTabFetch = 'Microsoft.OnTeamsTabFetch',
  OnTeamsTabSubmit = 'Microsoft.OnTeamsTabSubmit',

  /** Teams Actions */
  GetMeetingParticipant = 'Microsoft.GetMeetingParticipant',
  GetMember = 'Microsoft.GetMember',
  GetPagedMembers = 'Microsoft.GetPagedMembers',
  GetPagedTeamMembers = 'Microsoft.GetPagedTeamMembers',
  GetTeamChannels = 'Microsoft.GetTeamChannels',
  GetTeamDetails = 'Microsoft.GetTeamDetails',
  GetTeamMember = 'Microsoft.GetTeamMember',
  SendAppBasedLinkQueryResponse = 'Microsoft.SendAppBasedLinkQueryResponse',
  SendMessageToTeamsChannel = 'Microsoft.SendMessageToTeamsChannel',
  SendMessagingExtensionActionResponse = 'Microsoft.SendMessagingExtensionActionResponse',
  SendMessagingExtensionAttachmentsResponse = 'Microsoft.SendMessagingExtensionAttachmentsResponse',
  SendMessagingExtensionAuthResponse = 'Microsoft.SendMessagingExtensionAuthResponse',
  SendMessagingExtensionBotMessagePreviewResponse = 'Microsoft.SendMessagingExtensionBotMessagePreviewResponse',
  SendMessagingExtensionConfigQuerySettingUrlResponse = 'Microsoft.SendMessagingExtensionConfigQuerySettingUrlResponse',
  SendMessagingExtensionMessageResponse = 'Microsoft.SendMessagingExtensionMessageResponse',
  SendMessagingExtensionSelectItemResponse = 'Microsoft.SendMessagingExtensionSelectItemResponse',
  SendTaskModuleCardResponse = 'Microsoft.SendTaskModuleCardResponse',
  SendTaskModuleMessageResponse = 'Microsoft.SendTaskModuleMessageResponse',
  SendTaskModuleUrlResponse = 'Microsoft.SendTaskModuleUrlResponse',
}
