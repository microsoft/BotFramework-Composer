...
export const BotStatusList: React.FC<IBotStatusListProps> = (props) => {
  ...
  const headerStyle = css({ padding: '0 32px 0 11px', fontWeight: 400, textAlign: 'left' });
  const bodyStyle = css({ minWidth: '114px', maxWidth: '134px', padding: '11px 32px 11px 12px' });
