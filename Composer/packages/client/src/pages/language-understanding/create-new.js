...
export default function NewLuFileModal(props) {
      ...
      <div style={{ padding: '30px' }}>
        <div style={{ position: 'absolute', top: 10, right: 10 }}>
          <IconButton
            ...
            title={formatMessage('Add LU file')}
            ariaLabel={formatMessage('Add LU file')}
            onClick={onDismiss}
          />
        </div>
        <div>
          <form onSubmit={handleSubmit}>
            <TextField
              label={formatMessage('LU file name')}
