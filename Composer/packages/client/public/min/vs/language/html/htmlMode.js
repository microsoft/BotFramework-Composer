...
define('vs/language/html/workerManager', ['require', 'exports'], function (e, t) {
  ...
  (function (e) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (e.create = function (e, t, n, i) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (i.is(t.targetSelectionRange) || y.undefined(t.targetSelectionRange)) &&
              (i.is(t.originSelectionRange) || y.undefined(t.originSelectionRange))
            );
          });
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (y.undefined(t.additionalTextEdits) || y.typedArray(t.additionalTextEdits, c.is))
            );
          });
      ...
      })((o = t.DiagnosticRelatedInformation || (t.DiagnosticRelatedInformation = {}))),
      (function (e) {
        ...
        (e.create = function (e, t, n, i, r, a) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (y.undefined(t.relatedInformation) || y.typedArray(t.relatedInformation, o.is))
            );
          });
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return y.defined(t) && f.is(t.textDocument) && Array.isArray(t.edits);
          });
        ...
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              y.string(t.uri) &&
              (void 0 === t.options ||
                ((void 0 === t.options.overwrite || y.boolean(t.options.overwrite)) &&
                  (void 0 === t.options.ignoreIfExists || y.boolean(t.options.ignoreIfExists))))
            );
          });
        ...
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              y.string(t.uri) &&
              (void 0 === t.options ||
                ((void 0 === t.options.recursive || y.boolean(t.options.recursive)) &&
                  (void 0 === t.options.ignoreIfNotExists || y.boolean(t.options.ignoreIfNotExists))))
            );
          });
          ...
          return (
            ...
            (void 0 === t.documentChanges ||
              t.documentChanges.every(function (e) {
                return y.string(e.kind) ? h.is(e) || u.is(e) || p.is(e) : d.is(e);
              }))
          );
        };
      ...
      w = (function () {
        ...
        return (
          ...
          (e.prototype.getTextEditChange = function (e) {
            if (f.is(e)) {
              ...
              if (!(i = this._textEditChanges[t.uri])) {
                ...
                this._workspaceEdit.documentChanges.push(n), (i = new v(r)), (this._textEditChanges[t.uri] = i);
              }
              return i;
            }
            if (
            ...
            if (!(i = this._textEditChanges[e])) {
              var r = [];
              (this._workspaceEdit.changes[e] = r), (i = new v(r)), (this._textEditChanges[e] = i);
            }
            return i;
          }),
          ...
          (e.prototype.renameFile = function (e, t, n) {
            this.checkDocumentChanges(), this._workspaceEdit.documentChanges.push(u.create(e, t, n));
          }),
    ...
    (t.WorkspaceChange = w),
      ...
      })((f = t.VersionedTextDocumentIdentifier || (t.VersionedTextDocumentIdentifier = {}))),
      (function (e) {
        (e.create = function (e, t, n, i) {
      ...
      (function (e) {
        e.is = function (e) {
          ...
          return (
            !!t &&
            y.objectLiteral(t) &&
            (b.is(t.contents) || _.is(t.contents) || y.typedArray(t.contents, _.is)) &&
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              y.defined(t) && y.typedArray(t.diagnostics, s.is) && (void 0 === t.only || y.typedArray(t.only, y.string))
            );
          });
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          var i = { title: e };
          return l.is(t) ? (i.command = t) : (i.edit = t), void 0 !== n && (i.kind = n), i;
        }),
          (e.is = function (e) {
            var t = e;
            return (
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return y.defined(t) && i.is(t.range) && (y.undefined(t.command) || l.is(t.command));
          });
  ...
  (function (e) {
    ...
    !(function (e) {
      ...
      (function (e) {
        e.LATEST = {
          textDocument: {
            completion: { completionItem: { documentationFormat: [n.MarkupKind.Markdown, n.MarkupKind.PlainText] } },
            hover: { contentFormat: [n.MarkupKind.Markdown, n.MarkupKind.PlainText] },
          },
        };
  ...
  (function (e) {
    ...
    t.createScanner = function (e, t, n) {
      void 0 === t && (t = 0), void 0 === n && (n = i.ScannerState.WithinContent);
      var m,
        f,
        g,
        b,
        ...
        scan: function () {
          var e = w.pos(),
            ...
            n = (function e() {
              ...
              switch (y) {
                case i.ScannerState.WithinComment:
                  return w.advanceIfChars([s, s, c])
                    ? ((y = i.ScannerState.WithinContent), x(n, i.TokenType.EndCommentTag))
                    : (w.advanceUntilChars([s, s, c]), x(n, i.TokenType.Comment));
                case i.ScannerState.WithinDoctype:
                  return w.advanceIfChar(c)
                    ? ((y = i.ScannerState.WithinContent), x(n, i.TokenType.EndDoctypeTag))
                  ...
                  if (w.advanceIfChar(l)) {
                    if (!w.eos() && w.peekChar() === o) {
                      if (w.advanceIfChars([o, s, s]))
                        return (y = i.ScannerState.WithinComment), x(n, i.TokenType.StartCommentTag);
                      if (w.advanceIfRegExp(/^!doctype/i))
                        return (y = i.ScannerState.WithinDoctype), x(n, i.TokenType.StartDoctypeTag);
                    }
                    return w.advanceIfChar(d)
                      ? ((y = i.ScannerState.AfterOpeningEndTag), x(n, i.TokenType.EndTagOpen))
                      : ((y = i.ScannerState.AfterOpeningStartTag), x(n, i.TokenType.StartTagOpen));
                  }
                  return w.advanceUntilChar(l), x(n, i.TokenType.Content);
                case i.ScannerState.AfterOpeningEndTag:
                  return S().length > 0
                    ? ((y = i.ScannerState.WithinEndTag), x(n, i.TokenType.EndTag))
                    : w.skipWhitespace()
                    ? x(
                        n,
                        i.TokenType.Whitespace,
                        r('error.unexpectedWhitespace', 'Tag name must directly follow the open bracket.')
                      )
                    : ((y = i.ScannerState.WithinEndTag),
                      w.advanceUntilChar(c),
                      n < w.pos()
                        ? x(n, i.TokenType.Unknown, r('error.endTagNameExpected', 'End tag name expected.'))
                        : e());
                case i.ScannerState.WithinEndTag:
                  if (w.skipWhitespace()) return x(n, i.TokenType.Whitespace);
                  if (w.advanceIfChar(c)) return (y = i.ScannerState.WithinContent), x(n, i.TokenType.EndTagClose);
                ...
                case i.ScannerState.AfterOpeningStartTag:
                  return (
                    ...
                    (b = void 0),
                    g.length > 0
                      ? ((f = !1), (y = i.ScannerState.WithinTag), x(n, i.TokenType.StartTag))
                      : w.skipWhitespace()
                      ? x(
                          n,
                          i.TokenType.Whitespace,
                      ...
                      : ((y = i.ScannerState.WithinTag),
                        w.advanceUntilChar(c),
                        n < w.pos()
                          ? x(n, i.TokenType.Unknown, r('error.startTagNameExpected', 'Start tag name expected.'))
                          : e())
                  );
                case i.ScannerState.WithinTag:
                  return w.skipWhitespace()
                    ? ((f = !0), x(n, i.TokenType.Whitespace))
                    : f && (b = w.advanceIfRegExp(/^[^\s"'>/=\x00-\x0F\x7F\x80-\x9F]*/).toLowerCase()).length > 0
                    ? ((y = i.ScannerState.AfterAttributeName), (f = !1), x(n, i.TokenType.AttributeName))
                    : w.advanceIfChars([d, c])
                    ? ((y = i.ScannerState.WithinContent), x(n, i.TokenType.StartTagSelfClose))
                    : w.advanceIfChar(c)
                    ? ((y =
                        'script' === g
                          ? _ && v[_]
                    ...
                    : (w.advance(1),
                      x(n, i.TokenType.Unknown, r('error.unexpectedCharacterInTag', 'Unexpected character in tag.')));
                case i.ScannerState.AfterAttributeName:
                  return w.skipWhitespace()
                    ? ((f = !0), x(n, i.TokenType.Whitespace))
                    : w.advanceIfChar(h)
                    ? ((y = i.ScannerState.BeforeAttributeValue), x(n, i.TokenType.DelimiterAssign))
                ...
                case i.ScannerState.BeforeAttributeValue:
                  ...
                  if (a.length > 0)
                    return (
                      w.peekChar() === c && w.peekChar(-1) === d && (w.goBack(1), (a = a.substr(0, a.length - 1))),
                      'type' === b && (_ = a),
                      (y = i.ScannerState.WithinTag),
                      (f = !1),
                  ...
                  return m === p || m === u
                    ? (w.advance(1),
                      ...
                      'type' === b && (_ = w.getSource().substring(n + 1, w.pos() - 1)),
                      (y = i.ScannerState.WithinTag),
                      (f = !1),
                      x(n, i.TokenType.AttributeValue))
                ...
                case i.ScannerState.WithinScriptContent:
                  for (var T = 1; !w.eos(); ) {
                    ...
                    if (0 === k.length) return w.goToEnd(), x(n, i.TokenType.Script);
                    if ('\x3c!--' === k) 1 === T && (T = 2);
                    else if ('--\x3e' === k) T = 1;
                    else if ('/' !== k[1]) 2 === T && (T = 3);
                    else {
                  ...
                  return (y = i.ScannerState.WithinContent), n < w.pos() ? x(n, i.TokenType.Script) : e();
              ...
              return w.advance(1), (y = i.ScannerState.WithinContent), x(n, i.TokenType.Unknown, t);
            })();
          return n !== i.TokenType.EOS && e === w.pos()
            ? (console.log('Scanner.scan has not advanced at offset ' + e + ', state before: ' + t + ' after: ' + y),
              w.advance(1),
  ...
  (function (e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/languageFacts/fact', ['require', 'exports', '../utils/arrays'], e);
  })(function (e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 });
  ...
  (function (e) {
    ...
    (t.Node = o),
      (t.parse = function (e) {
          ...
          switch (h) {
            ...
            case r.TokenType.StartTagClose:
              (s.end = t.getTokenEnd()),
                ...
                s.tag && a.isVoidElement(s.tag) && s.parent && ((s.closed = !0), (s = s.parent));
              break;
            case r.TokenType.StartTagSelfClose:
              s.parent &&
                ((s.closed = !0), (s.end = t.getTokenEnd()), (s.startTagEnd = t.getTokenEnd()), (s = s.parent));
              break;
        ...
        return { roots: i.children, findNodeBefore: i.findNodeBefore.bind(i), findNodeAt: i.findNodeAt.bind(i) };
      });
  }),
  (function (e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
  ...
  (function (e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/utils/markup', ['require', 'exports'], e);
  })(function (e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
  ...
  (function (e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/languageFacts/dataProvider', ['require', 'exports', '../utils/markup'], e);
  })(function (e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 });
      ...
      i = (function () {
        ...
        return (
          ...
          (e.prototype.provideValues = function (e, t) {
            ...
            return this._tagMap[e] ? (r(this._tagMap[e].attributes), r(this._globalAttributes), i) : [];
          }),
          e
        );
      })();
  ...
  (function (e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/languageFacts/data/webCustomData', ['require', 'exports'], e);
  })(function (e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.htmlData = {
  ...
  (function (e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/utils/object', ['require', 'exports'], e);
  })(function (e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
  ...
  (function (e) {
        ...
        return (
          ...
          (e.prototype._doComplete = function (e, t, o, d) {
            var p = { isIncomplete: !1, items: [] },
              ...
              b = l.getAllDataProviders().filter(function (t) {
                return t.isApplicable(e.languageId) && (!d || !1 !== d[t.getId()]);
              }),
            ...
            function E(e, t, i) {
              void 0 === i && (i = w);
              var a = x(e, i),
                o = f(v, i, r.ScannerState.WithinEndTag, r.TokenType.EndTagClose) ? '' : '>',
                s = y;
              for (t && (s = s.parent); s; ) {
                var l = s.tag;
                if (l && (!s.closed || (s.endTagStart && s.endTagStart > w))) {
                  ...
                  if (null !== d && null !== u && d !== u) {
                    var m = d + '</' + l + o;
                    (c.textEdit = n.TextEdit.replace(x(e - 1 - u.length), m)), (c.filterText = u + '</' + l);
                  }
            ...
            function I(e, t) {
              ...
              var a = x(e, i),
                l = f(v, t, r.ScannerState.AfterAttributeName, r.TokenType.DelimiterAssign) ? '' : '="$1"',
                c = S.toLowerCase(),
                  ...
                  e.provideAttributes(c).forEach(function (e) {
                    if (!d[e.name]) {
                      ...
                      'v' !== e.valueSet &&
                        ...
                        p.items.push({
                          label: e.name,
                          kind: 'handler' === e.valueSet ? n.CompletionItemKind.Function : n.CompletionItemKind.Value,
                          documentation: h.generateDocumentation(e, _),
                ...
                (function (e, t) {
                      ...
                      o.roots.forEach(function (e) {
                        return (function e(n) {
                          n.attributeNames.forEach(function (e) {
                            !s.startsWith(e, i) || r[e] || t[e] || (r[e] = e + '="$1"');
                          }),
                  ...
                  Object.keys(r).forEach(function (t) {
                    return p.items.push({
                      ...
                      textEdit: n.TextEdit.replace(e, r[t]),
                      insertTextFormat: n.InsertTextFormat.Snippet,
                    });
                  });
                })(a, d),
            ...
            function C(i, r) {
              var a, o, s, l;
              if ((void 0 === r && (r = w), w > i && w <= r && ((l = v[i]), /^["']*$/.test(l)))) {
                var c = i + 1,
                  d = r;
                r > i && v[r - 1] === v[i] && d--;
                ...
                (a = x(u, f)), (s = w >= c && w <= d ? v.substring(c, w) : ''), (o = !1);
              ...
              if (g.length > 0)
                for (var L = x(i, r), M = 0, E = g; M < E.length; M++) {
                  ...
                  A.onHtmlAttributeValue &&
                    A.onHtmlAttributeValue({ document: e, position: t, tag: y, attribute: k, value: s, range: L });
                }
              return (
                b.forEach(function (e) {
            ...
            function z(e) {
              return w === k.getTokenEnd() && (D = k.scan()) === e && k.getTokenOffset() === w ? k.getTokenEnd() : w;
            }
            function H() {
            ...
            function U() {
              for (var e = w - 1, i = t.character; e >= 0 && s.isLetterOrDigit(v, e); ) e--, i--;
              if (e >= 0 && '&' === v[e]) {
                ...
                for (var o in a.entities)
                  if (s.endsWith(o, ';')) {
                    ...
                    p.items.push({
                      ...
                      documentation: u('entity.propose', "Character entity representing '" + a.entities[o] + "'"),
            ...
            for (var W, D = k.scan(); D !== r.TokenType.EOS && k.getTokenOffset() <= w; ) {
              switch (D) {
                case r.TokenType.StartTagOpen:
                  if (k.getTokenEnd() === w) {
                  ...
                  break;
                case r.TokenType.StartTag:
                  if (k.getTokenOffset() <= w && w <= k.getTokenEnd()) return L(k.getTokenOffset(), k.getTokenEnd());
                  S = k.getTokenText();
                  break;
                case r.TokenType.AttributeName:
                  if (k.getTokenOffset() <= w && w <= k.getTokenEnd()) return I(k.getTokenOffset(), k.getTokenEnd());
                  T = k.getTokenText();
                  break;
                case r.TokenType.DelimiterAssign:
                  ...
                  break;
                case r.TokenType.AttributeValue:
                  if (k.getTokenOffset() <= w && w <= k.getTokenEnd()) return C(k.getTokenOffset(), k.getTokenEnd());
                  break;
                case r.TokenType.Whitespace:
                  ...
                  break;
                case r.TokenType.EndTagOpen:
                  if (w <= k.getTokenEnd()) return E(k.getTokenOffset() + 1, !1, z(r.TokenType.EndTag));
                  break;
                case r.TokenType.EndTag:
                  if (w <= k.getTokenEnd())
            ...
            if ('>' === o) {
              if (
                ...
                for (
                  ...
                  if (s === r.TokenType.StartTagClose && d.getTokenEnd() === a) return '$0</' + l.tag + '>';
                  s = d.scan();
                }
            } else if ('/' === o) {
              ...
              if (l && l.tag) {
                ...
                for (
                  ...
                  if (s === r.TokenType.EndTagOpen && d.getTokenEnd() === a) return l.tag + '>';
                  s = d.scan();
                }
              }
            }
          ...
          (e.prototype.doesSupportMarkdown = function () {
            if (!d.isDefined(this.supportsMarkdown)) {
              if (!d.isDefined(this.clientCapabilities)) return (this.supportsMarkdown = !0), this.supportsMarkdown;
              var e =
    ...
    function f(e, t, n, a) {
      for (var o = i.createScanner(e, t, n), s = o.scan(); s === r.TokenType.Whitespace; ) s = o.scan();
      return s === a;
    }
    t.HTMLCompletion = p;
  }),
        ...
        return (
          (e.prototype.doHover = function (e, t, i) {
            ...
            function p(t, i) {
              for (
                ...
                o !== r.TokenType.EOS && (a.getTokenEnd() < c || (a.getTokenEnd() === c && o !== t));

              )
                o = a.scan();
              return o === t && c <= a.getTokenEnd()
                ? { start: e.positionAt(a.getTokenOffset()), end: e.positionAt(a.getTokenEnd()) }
                : null;
            }
                  ...
                  var i = function (i) {
                      ...
                      if (
                        (i.provideAttributes(e).forEach(function (e) {
                          t === e.name && e.description && (r = { contents: s.generateDocumentation(e, l), range: n });
                        }),
                        r)
                      )
                        return (r.contents = o(r.contents)), { value: r };
            ...
            if (b) {
              var _ = d.tag,
                ...
                w = (function (t, i) {
                  for (
                    var a = n.createScanner(e.getText(), t), o = a.scan(), s = void 0;
                    o !== r.TokenType.EOS && a.getTokenEnd() <= i;

                  )
                    (o = a.scan()) === r.TokenType.AttributeName && (s = a.getTokenText());
                  return s;
                    ...
                    var r = function (r) {
                        ...
                        if (
                          (r.provideValues(e, t).forEach(function (e) {
                            n === e.name &&
                              e.description &&
                              (a = { contents: s.generateDocumentation(e, l), range: i });
                          }),
                          a)
                        )
          ...
          (e.prototype.doesSupportMarkdown = function () {
            if (!o.isDefined(this.supportsMarkdown)) {
              if (!o.isDefined(this.clientCapabilities)) return (this.supportsMarkdown = !0), this.supportsMarkdown;
              var e =
                this.clientCapabilities &&
                this.clientCapabilities.textDocument &&
                this.clientCapabilities.textDocument.hover;
        ...
        (i.prototype.clone_empty = function () {
          ...
          (a.prototype.set_indent = function (e, t) {
            return (
              ...
              this.__lines.length > 1 ? (this.current_line.set_indent(e, t), !0) : (this.current_line.set_indent(), !1)
            );
          }),
      ...
      function (e, t, n) {
        ...
        (r.prototype.restart = function () {
          ...
          (r.prototype.peek = function (e) {
            var t = null;
            return (
              (e = e || 0), (e += this.__position) >= 0 && e < this.__input_length && (t = this.__input.charAt(e)), t
            );
          }),
      ...
      function (e, t, n) {
        ...
        (p.prototype.eatString = function (e) {
          ...
          (p.prototype.eatWhitespace = function (e) {
            for (var t = c.test(this._input.peek()), n = !0; c.test(this._input.peek()); )
              (this._ch = this._input.next()),
                e &&
                  '\n' === this._ch &&
              ...
              if ('/' === this._ch && '*' === this._input.peek()) {
                ...
                if ((this.preserveSingleSpace(i), '{' === this._input.peek()))
                  ...
                  k.match(/[ :]$/) &&
                    ...
                    this.print_string(k),
                    (this._output.space_before_token = !0)),
                    'extend' === (k = k.replace(/\s$/, '')) ? (_ = !0) : 'import' === k && (v = !0),
                ...
                '#' === this._ch && '{' === this._input.peek()
                  ...
                  ? this._input.lookBack('url')
                    ? (this.print_string(this._ch),
                      ...
                      ')' === this._ch || '"' === this._ch || "'" === this._ch
                        ? this._input.back()
                        : this._ch && (this.print_string(this._ch + this.eatString(')')), m && (m--, this.outdent())))
                    : (this.preserveSingleSpace(i),
                      this.print_string(this._ch),
                      this.eatWhitespace(),
                      m++,
                  ...
                  ? (this.print_string(this._ch),
                    this.eatWhitespace(!0),
                    !this._options.selector_separator_newline || g || 0 !== m || v
                      ? (this._output.space_before_token = !0)
                      : this._output.add_new_line())
                ...
                (this._disabled.handlebars ||
                  ...
                  (e =
                    (e =
                      ...
                      this.__patterns.handlebars_unescaped.read()) || this.__patterns.handlebars.read()),
                this._disabled.django ||
                  (this._excluded.django || this._excluded.handlebars || (e = e || this.__patterns.django_value.read()),
                  this._excluded.django ||
                    (e = (e = e || this.__patterns.django_comment.read()) || this.__patterns.django.read())));
            return e;
          }),
      ...
      function (e, t, n) {
        ...
        (p.prototype.get_parser_token = function () {
          ...
          (p.prototype._try_pop_frame = function (e) {
            ...
            return (
              e &&
                ((t = e.parser_token), (this._printer.indent_level = e.indent_level), (this._current_frame = e.parent)),
              t
            );
          }),
            ...
            if ((e.set_space_before_token(t.newlines || '' !== t.whitespace_before, !0), n.is_unformatted))
              ...
              if (
                (t.type === o.ATTRIBUTE
                  ...
                  : t.type === o.VALUE && t.previous.type === o.EQUALS && e.set_space_before_token(!1),
                t.type === o.ATTRIBUTE &&
                  '<' === n.tag_start_char &&
          ...
          (m.prototype._print_custom_beatifier_text = function (e, t, n) {
            ...
            if ('' !== t.text) {
              ...
              s && (a = a ? s + a + '\n' + l : s + l),
                e.print_newline(!1),
                a &&
                  ((t.text = a), (t.whitespace_before = ''), (t.newlines = 0), e.add_raw_token(t), e.print_newline(!0));
            }
          }),
        ...
        (m.prototype._get_tag_open_token = function (e) {
          ...
          return (
            ...
            (t.is_end_tag = t.is_end_tag || h(t.tag_check, this._options.void_elements)),
            (t.is_empty_element = t.tag_complete || (t.is_start_tag && t.is_end_tag)),
            (t.is_unformatted = !t.tag_complete && h(t.tag_check, this._options.unformatted)),
            (t.is_content_unformatted = !t.is_empty_element && h(t.tag_check, this._options.content_unformatted)),
            (t.is_inline_element = h(t.tag_name, this._options.inline) || '{' === t.tag_start_char),
            t
          );
        }),
            ...
            if (!e.is_empty_element && e.is_start_tag && e.parent)
              return (
                'body' === e.tag_name
                  ...
                  ? (t = (t = t || this._tag_stack.try_pop('dt', ['dl'])) || this._tag_stack.try_pop('dd', ['dl']))
        ...
        ((d.prototype = new i())._is_comment = function (e) {
                    ...
                    (n =
                      (n =
                        (n =
                          (n =
                            (n =
                              (n = (n = n || this._read_open_handlebars(i, t)) || this._read_attribute(i, e, t)) ||
                              this._read_raw_content(i, e, t)) || this._read_close(i, t)) ||
                          this._read_content_word(i)) || this._read_comment_or_cdata(i)) || this._read_processing(i)) ||
                    this._read_open(i, t)) || this._create_token(l.UNKNOWN, this._input.next()));
          }),
            ...
            '<' === e &&
              ('!' === this._input.peek(1) &&
                ((n = this.__patterns.comment.read())
                  ? (i = c.get_directives(n)) && 'start' === i.ignore && (n += c.readIgnored(this._input))
          ...
          (d.prototype._read_processing = function (e) {
            ...
            if ('<' === e) {
              ...
              ('!' !== i && '?' !== i) ||
                (n = (n = this.__patterns.conditional_comment.read()) || this.__patterns.processing.read()),
  ...
  (function (e) {
    ...
    t.format = function (e, t, c) {
      ...
      if (t) {
        ...
        (b === d.length || s(d, b)) && (g = b), (t = n.Range.create(e.positionAt(m), e.positionAt(g)));
        var _ = d.substring(0, m);
        if (new RegExp(/.*[<][^>]*$/).test(_)) return [{ range: t, newText: d = d.substring(m, g) }];
      ...
      } else t = n.Range.create(n.Position.create(0, 0), e.positionAt(d.length));
      var w = {
          indent_size: p,
...
!(function (e) {
      ...
      return (
        ...
        (e.parse = function (e, t) {
          ...
          return n
            ? new p(
                n[2] || l,
                decodeURIComponent(n[4] || l),
                decodeURIComponent(n[5] || l),
                decodeURIComponent(n[7] || l),
                decodeURIComponent(n[9] || l),
                t
              )
            : new p(l, l, l, l, l);
        }),
        (e.file = function (e) {
          ...
          if ((i && (e = e.replace(/\\/g, c)), e[0] === c && e[1] === c)) {
            var n = e.indexOf(c, 2);
            -1 === n ? ((t = e.substring(2)), (e = c)) : ((t = e.substring(2, n)), (e = e.substring(n) || c));
          }
        ...
        (e.revive = function (t) {
          if (t) {
            ...
            var n = new p(t);
            return (n._formatted = t.external), (n._fsPath = t._sep === u ? t.fsPath : null), n;
          }
          return t;
        }),
        e
    ...
    p = (function (e) {
      ...
      return (
        ...
        (t.prototype.toJSON = function () {
          var e = { $mid: 1 };
          return (
            this._fsPath && ((e.fsPath = this._fsPath), (e._sep = u)),
  ...
  function _(e, t) {
    ...
    if ((r && ((i += r), (i += ':')), (a || 'file' === r) && ((i += c), (i += c)), a)) {
      ...
      if (-1 !== d) {
        ...
        (a = a.substr(d + 1)),
          -1 === (d = h.indexOf(':'))
            ? (i += n(h, !1))
            : ((i += n(h.substr(0, d), !1)), (i += ':'), (i += n(h.substr(d + 1), !1))),
          (i += '@');
      }
    ...
    if (o) {
      if (o.length >= 3 && 47 === o.charCodeAt(0) && 58 === o.charCodeAt(2))
        (u = o.charCodeAt(1)) >= 65 && u <= 90 && (o = '/' + String.fromCharCode(u + 32) + ':' + o.substr(3));
    ...
    return s && ((i += '?'), (i += n(s, !1))), l && ((i += '#'), (i += t ? l : f(l, !1))), i;
  }
}),
    ...
    function l(e, t, n, o, l, c) {
      ...
      if (
        ...
        if (
          ...
          return { range: i.Range.create(e.positionAt(o), e.positionAt(l)), target: p };
      }
    }
    t.findDocumentLinks = function (e, t) {
      for (
        var i = [], a = n.createScanner(e.getText(), 0), c = a.scan(), d = void 0, h = !1, u = void 0, p = {};
        c !== o.TokenType.EOS;
        ...
        switch (c) {
          ...
          case o.TokenType.AttributeValue:
            if ('src' === d || 'href' === d) {
              ...
              if (!h) (b = l(e, t, m, a.getTokenOffset(), a.getTokenEnd(), u)) && i.push(b);
              h && void 0 === u && (u = s(m)) && t && (u = t.resolveReference(u, e.uri)), (h = !1), (d = void 0);
            } else if ('id' === d) {
  ...
  (function (e) {
    ...
    function s(e, t, i) {
      for (var a = n.createScanner(t.getText(), i), o = a.scan(); o !== r.TokenType.EOS && o !== e; ) o = a.scan();
      return o !== r.TokenType.EOS
        ? { start: t.positionAt(a.getTokenOffset()), end: t.positionAt(a.getTokenEnd()) }
        : null;
    }
    t.findDocumentHighlights = function (e, t, n) {
      ...
      var c = [],
        ...
        h = 'number' == typeof l.endTagStart && s(r.TokenType.EndTag, e, l.endTagStart);
      return (
        ((d && o(d, t)) || (h && o(h, t))) &&
        ...
        t.roots.forEach(function (t) {
          !(function e(t, i, r, a) {
            var o = (function (e) {
              ...
              s = n.Location.create(t.uri, n.Range.create(t.positionAt(i.start), t.positionAt(i.end))),
  ...
  (function (e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/services/htmlRename', ['require', 'exports'], e);
  })(function (e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.doRename = function (e, t, n, i) {
        ...
        if (
          !(function (e, t, n) {
            if (e.endTagStart && e.endTagStart + '</'.length <= t && t <= e.endTagStart + '</'.length + n.length)
              return !0;
  ...
  (function (e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/services/htmlMatchingTagPosition', ['require', 'exports'], e);
  })(function (e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        switch (s) {
          ...
          case i.TokenType.StartTagSelfClose:
            ...
            if (f >= 0) {
              var g = c[f];
              (c.length = f),
                (_ = e.positionAt(o.getTokenOffset()).line - 1) > (m = g.startLine) &&
                  h !== m &&
              ...
              if (b[1]) c.push({ startLine: m, tagName: '' });
                ...
                if (f >= 0) {
                  ...
                  (c.length = f),
                    (_ = m) > (m = g.startLine) &&
                      h !== m &&
                      u({ startLine: m, endLine: _, kind: n.FoldingRangeKind.Region });
                }
              }
            else
              m < (_ = e.positionAt(o.getTokenOffset() + o.getTokenLength()).line) &&
                u({ startLine: m, endLine: _, kind: n.FoldingRangeKind.Comment });
        }
        s = o.scan();
      }
      ...
      for (
        ...
        switch (d) {
          case a.TokenType.AttributeName:
            ...
            l <= c.getTokenEnd() && u.unshift([c.getTokenOffset(), c.getTokenEnd()]),
              (p = !0),
              (m = c.getTokenOffset());
            break;
        ...
        for (
          var i = (function (e, t) {
              ...
              if (s.startTagEnd && !s.endTagStart) {
                ...
                var c = n.Range.create(e.positionAt(s.startTagEnd - 2), e.positionAt(s.startTagEnd));
                '/>' === e.getText(c)
              ...
              if ((l.unshift([s.start, s.end]), s.start < a && a < s.startTagEnd)) {
                l.unshift([s.start + 1, s.startTagEnd - 1]);
                d = o(e, s, a);
                return (l = d.concat(l));
              }
              return s.startTagEnd <= a && a <= s.endTagStart
                ...
                : (a >= s.endTagStart + 2 && l.unshift([s.endTagStart + 2, s.end - 1]), l);
            })(e, t),
            a = void 0,
            s = void 0,
            l = i.length - 1;
          ...
          var c = i[l];
          (a && c[0] === a[0] && c[1] === a[1]) ||
            (s = n.SelectionRange.create(n.Range.create(e.positionAt(i[l][0]), e.positionAt(i[l][1])), s)),
            (a = c);
        }
          ...
          for (var a = 0, o = t; a < o.length; a++) {
            ...
            if (e.isIncremental(s)) {
              ...
              var h = Math.max(l.start.line, 0),
                ...
                p = this._lineOffsets,
                m = i(s.text, !1, c);
              if (u - h === m.length) for (var f = 0, g = m.length; f < g; f++) p[f + h + 1] = m[f];
              else
                m.length < 1e4
                  ? p.splice.apply(p, [h + 1, u - h].concat(m))
                  : (this._lineOffsets = p = p.slice(0, h + 1).concat(m, p.slice(u + 1)));
              var b = s.text.length - (d - c);
              if (0 !== b) for (f = h + 1 + m.length, g = p.length; f < g; f++) p[f] = p[f] + b;
            } else {
      ...
      (e.create = function (e, t, i, r) {
        ...
        (e.applyEdits = function (e, t) {
          for (
            ...
            (n = n.substring(0, l) + s.newText + n.substring(c, n.length)), (r = l);
          }
          return n;
        });
    })(t.TextDocument || (t.TextDocument = {}));
  ...
  (function (e) {
    ...
    (t.TextDocument = b.TextDocument),
      ...
      (t.getLanguageService = function (e) {
        ...
        return (
          e && e.customDataProviders && f.handleCustomDataProviders(e.customDataProviders),
          {
  ...
  define('vs/language/html/languageFeatures', ['require', 'exports', 'vscode-html-languageservice'], function (
    e,
    t,
    n
  ) {
            ...
            .then(function (i) {
              if (i) {
                var a = e.getWordUntilPosition(t),
                  o = new r(t.lineNumber, a.startColumn, t.lineNumber, a.endColumn),
                  s = i.items.map(function (e) {
                    ...
                    return (
                      e.textEdit && ((t.range = l(e.textEdit.range)), (t.insertText = e.textEdit.newText)),
                      e.additionalTextEdits && (t.additionalTextEdits = e.additionalTextEdits.map(d)),
            ...
            .then(function (e) {
              return (function (e) {
                ...
                for (var n in e.changes) {
                  for (var r = [], a = 0, o = e.changes[n]; a < o.length; a++) {
                    var s = o[a];
                    r.push({ range: l(s.range), text: s.newText });
                  }
                  t.push({ resource: i.parse(n), edits: r });
                }
                return { edits: t };
              })(e);
            });
        ...
        (e.prototype.provideSelectionRanges = function (e, t, n) {
          ...
          return this._worker(i)
            ...
            .then(function (e) {
              if (e)
                return e.map(function (e) {
                  for (var t = []; e; ) t.push({ range: l(e.range) }), (e = e.parent);
                  return t;
                });
            });
        }),
  ...
  define('vs/language/html/htmlMode', ['require', 'exports', './workerManager', './languageFeatures'], function (
    e,
    t,
    n,
    i
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.setupMode1 = function (e) {
        var t = new n.WorkerManager(e),
          ...
          a = e.languageId;
        monaco.languages.registerCompletionItemProvider(a, new i.CompletionAdapter(r)),
          monaco.languages.registerHoverProvider(a, new i.HoverAdapter(r)),
          monaco.languages.registerDocumentHighlightProvider(a, new i.DocumentHighlightAdapter(r)),
          monaco.languages.registerLinkProvider(a, new i.DocumentLinkAdapter(r)),
          monaco.languages.registerFoldingRangeProvider(a, new i.FoldingRangeAdapter(r)),
          monaco.languages.registerDocumentSymbolProvider(a, new i.DocumentSymbolAdapter(r)),
          monaco.languages.registerSelectionRangeProvider(a, new i.SelectionRangeAdapter(r)),
          monaco.languages.registerRenameProvider(a, new i.RenameAdapter(r)),
          'html' === a &&
            (monaco.languages.registerDocumentFormattingEditProvider(a, new i.DocumentFormattingEditProvider(r)),
      ...
      (t.setupMode = function (e) {
        ...
        return (
          ...
          a(o),
          c.completionItems && o.push(monaco.languages.registerCompletionItemProvider(l, new i.CompletionAdapter(d))),
          c.hovers && o.push(monaco.languages.registerHoverProvider(l, new i.HoverAdapter(d))),
          c.documentHighlights &&
            o.push(monaco.languages.registerDocumentHighlightProvider(l, new i.DocumentHighlightAdapter(d))),
          c.links && o.push(monaco.languages.registerLinkProvider(l, new i.DocumentLinkAdapter(d))),
          c.documentSymbols &&
            o.push(monaco.languages.registerDocumentSymbolProvider(l, new i.DocumentSymbolAdapter(d))),
          c.rename && o.push(monaco.languages.registerRenameProvider(l, new i.RenameAdapter(d))),
          c.foldingRanges && o.push(monaco.languages.registerFoldingRangeProvider(l, new i.FoldingRangeAdapter(d))),
          c.selectionRanges &&
            o.push(monaco.languages.registerSelectionRangeProvider(l, new i.SelectionRangeAdapter(d))),
          c.documentFormattingEdits &&
            o.push(monaco.languages.registerDocumentFormattingEditProvider(l, new i.DocumentFormattingEditProvider(d))),
