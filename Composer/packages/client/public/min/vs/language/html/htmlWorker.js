            ...
            for (var W, D = k.scan(); D !== r.TokenType.EOS && k.getTokenOffset() <= w; ) {
              switch (D) {
                ...
                case r.TokenType.StartTag:
                  ...
                  break;
                case r.TokenType.AttributeName:
                  if (k.getTokenOffset() <= w && w <= k.getTokenEnd()) return z(k.getTokenOffset(), k.getTokenEnd());
                  T = k.getTokenText();
                  break;
                case r.TokenType.DelimiterAssign:
                  ...
                  break;
                case r.TokenType.AttributeValue:
                  if (k.getTokenOffset() <= w && w <= k.getTokenEnd()) return H(k.getTokenOffset(), k.getTokenEnd());
                  break;
                case r.TokenType.Whitespace:
                  ...
                  break;
                case r.TokenType.EndTagOpen:
                  if (w <= k.getTokenEnd()) return E(k.getTokenOffset() + 1, !1, I(r.TokenType.EndTag));
                  break;
                case r.TokenType.EndTag:
                  if (w <= k.getTokenEnd())
    ...
    var r = (function () {
      ...
      return (
        ...
        (e.prototype.doComplete = function (e, t) {
          ...
          return Promise.resolve(
            this._languageService.doComplete(n, t, i, this._languageSettings && this._languageSettings.suggest)
          );
        }),
        (e.prototype.format = function (e, t, n) {
          var i = this._getTextDocument(e),
            r = this._languageService.format(i, t, this._languageSettings && this._languageSettings.format);
        ...
        (e.prototype._getTextDocument = function (e) {
          for (var t = 0, i = this._ctx.getMirrorModels(); t < i.length; t++) {
            var r = i[t];
            if (r.uri.toString() === e) return n.TextDocument.create(e, this._languageId, r.version, r.getValue());
          }
          return null;
        }),
        e
