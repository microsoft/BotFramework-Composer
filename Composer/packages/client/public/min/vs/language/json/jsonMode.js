...
define('vs/language/json/workerManager', ['require', 'exports'], function (e, t) {
  ...
  (function (e) {
    ...
    (t.format = function (e, t, i) {
      ...
      var x = [];
      function S(t, n, r) {
        !v && n < l && r > u && e.substring(n, r) !== t && x.push({ offset: n, length: r - n, content: t });
      }
      var C = b();
      if (17 !== C) {
      ...
      for (; 17 !== C; ) {
        for (var T = g.getTokenOffset() + g.getTokenLength() + c, j = b(), E = ''; !h && (12 === j || 13 === j); ) {
  ...
  (function (e) {
    ...
    function o(e, t, n, o, a) {
      for (
        ...
        c.length > 0 && ((f = c.pop()), void 0 === (l = r.findNodeAtLocation(u, c)) && void 0 !== n);

      )
        'string' == typeof f ? (((s = {})[f] = n), (n = s)) : (n = [n]);
      if (l) {
        if ('object' === l.type && 'string' == typeof f && Array.isArray(l.children)) {
          ...
          if (void 0 !== d) {
            if (void 0 === n) {
              ...
              else if (((h = l.offset + 1), l.children.length > 1)) m = l.children[1].offset;
          ...
          return i(
            ...
            (y =
              v > 0
                ? { offset: (S = l.children[v - 1]).offset + S.length, length: 0, content: ',' + g }
                : 0 === l.children.length
        ...
        if ('array' === l.type && 'number' == typeof f && Array.isArray(l.children)) {
          if (-1 === f) {
            (g = '' + JSON.stringify(n)), (y = void 0);
            if (0 === l.children.length) y = { offset: l.offset + 1, length: 0, content: g };
            else y = { offset: (S = l.children[l.children.length - 1]).offset + S.length, length: 0, content: ',' + g };
            return i(e, y, o);
          }
          if (void 0 === n && l.children.length >= 0) {
            var b = f,
              x = l.children[b];
            y = void 0;
            if (1 === l.children.length) y = { offset: l.offset + 1, length: l.length - 2, content: '' };
            else if (l.children.length - 1 === b) {
              var S,
                C = (S = l.children[b - 1]).offset + S.length;
              y = { offset: C, length: l.offset + l.length - 2 - C, content: '' };
            } else y = { offset: x.offset, length: l.children[b + 1].offset - x.offset, content: '' };
            return i(e, y, o);
          }
          throw new Error('Array modification not supported yet');
        }
        throw new Error(
          'Can not add ' + ('number' != typeof f ? 'index' : 'property') + ' to parent of type ' + l.type
        );
      }
          ...
          return (
            ...
            (void 0 === t.documentChanges ||
              t.documentChanges.every(function (e) {
                return S.string(e.kind) ? f.is(e) || d.is(e) || p.is(e) : l.is(e);
              }))
          );
        };
          ...
          for (var i = 0, a = t; i < a.length; i++) {
            ...
            if (e.isIncremental(s)) {
              ...
              var f = Math.max(c.start.line, 0),
                ...
                p = this._lineOffsets,
                h = r(s.text, !1, u);
              if (d - f === h.length) for (var m = 0, g = h.length; m < g; m++) p[m + f + 1] = h[m];
              else
                h.length < 1e4
                  ? p.splice.apply(p, [f + 1, d - f].concat(h))
                  : (this._lineOffsets = p = p.slice(0, f + 1).concat(h, p.slice(d + 1)));
              var v = s.text.length - (l - u);
              if (0 !== v) for (m = f + 1 + h.length, g = p.length; m < g; m++) p[m] = p[m] + v;
            } else {
      ...
      switch (e.type) {
        case 'object':
          !(function (e, t, n, a) {
            ...
            if (t.properties)
              for (var S = 0, k = Object.keys(t.properties); S < k.length; S++) {
                h = k[S];
                x(h);
                ...
                if ((L = s[h]))
                  if (r.isBoolean(T))
                    if (T) n.propertiesMatches++, n.propertiesValueMatches++;
                      ...
                      var j = L.parent;
                      n.problems.push({
                        location: { offset: j.keyNode.offset, length: j.keyNode.length },
                        severity: o.DiagnosticSeverity.Warning,
            ...
            if (t.patternProperties)
              for (var O = 0, A = Object.keys(t.patternProperties); O < A.length; O++)
                for (var I = A[O], w = new RegExp(I), _ = 0, P = c.slice(0); _ < P.length; _++) {
                  h = P[_];
                  if (w.test(h))
                    if ((x(h), (L = s[h]))) {
            ...
            if (t.dependencies)
              for (var R = 0, V = Object.keys(t.dependencies); R < V.length; R++) {
                f = V[R];
                if (s[f]) {
              ...
              if (e.items.length > s.length)
                if ('object' == typeof t.additionalItems)
                  for (var f = s.length; f < e.items.length; f++) {
                    l = new y();
                    C(e.items[f], t.additionalItems, l, a), n.mergePropertyMatch(l);
                  }
                else
                  !1 === t.additionalItems &&
                    n.problems.push({
          ...
          !(function (e, t, n, a) {
            ...
            r.isNumber(l) &&
              ...
              n.problems.push({
                location: { offset: e.offset, length: e.length },
                severity: o.DiagnosticSeverity.Warning,
                message: i('exclusiveMinimumWarning', 'Value is below the exclusive minimum of {0}.', l),
              });
            ...
            r.isNumber(f) &&
              ...
              n.problems.push({
                location: { offset: e.offset, length: e.length },
                severity: o.DiagnosticSeverity.Warning,
                message: i('exclusiveMaximumWarning', 'Value is above the exclusive maximum of {0}.', f),
              });
            ...
            return this.schemaService.getSchemaForResource(e.uri, r).then(function (t) {
              ...
              if (u && 'object' === u.type) {
                ...
                o.contributions.forEach(function (t) {
                  var n = t.collectPropertyCompletions(e.uri, x, f, p, '' === b, m);
                  n && l.push(n);
                }),
                  !t &&
                    f.length > 0 &&
              ...
              return (
                ...
                o.contributions.length > 0 && o.getContributedValueCompletions(r, u, c, e, m, l),
          ...
          (e.prototype.getValueCompletions = function (e, t, n, r, o, i, a) {
            ...
            if (
              ...
              if (n && (null !== u || 'array' === n.type)) {
                ...
                t.getMatchingSchemas(e.schema, n.offset, l).forEach(function (e) {
      ...
      o = (function () {
        ...
        return (
          (e.prototype.doHover = function (e, t, o) {
            ...
            for (
              var l = r.Range.create(e.positionAt(c.offset), e.positionAt(c.offset + c.length)),
                f = function (e) {
...
!(function (e) {
    ...
    if ((o && ((r += o), (r += ':')), (i || 'file' === o) && ((r += u), (r += u)), i)) {
      ...
      if (-1 !== l) {
        ...
        (i = i.substr(l + 1)),
          -1 === (l = f.indexOf(':'))
            ? (r += n(f, !1))
            : ((r += n(f.substr(0, l), !1)), (r += ':'), (r += n(f.substr(l + 1), !1))),
          (r += '@');
      }
    ...
    var f = (function () {
      ...
      return (
          ...
          if (i.$schema) {
            ...
            if ('http://json-schema.org/draft-03/schema' === s)
              return this.promise.resolve(
                new l({}, [a('json.schema.draft03.notsupported', 'Draft-03 schemas are not supported.')])
              );
                ...
                var i = [e],
                  ...
                  c = function (e) {
                    for (var r = []; e.$ref; ) {
                      var a = e.$ref,
                        c = a.split('#', 2);
                      if ((delete e.$ref, c[0].length > 0)) return void s.push(f(e, c[0], c[1], n, o));
        ...
        (e.prototype.getSchemaForResource = function (e, t) {
          ...
          for (var s = Object.create(null), c = [], u = 0, l = this.filePatternAssociations; u < l.length; u++) {
            var f = l[u];
      ...
      a = (function () {
        ...
        return (
          (e.prototype.findDocumentSymbols = function (e, t, o) {
                ...
                if ('object' === h.type)
                  for (var m = 0, g = h.properties; m < g.length; m++) {
                    ...
                    if ('key' === v.keyNode.value && v.valueNode) {
                      ...
                      if (
                        (f.push({ name: n.getNodeValue(v.valueNode), kind: i.SymbolKind.Function, location: y }),
                        --u <= 0)
                      )
                        return o && o.onResultLimitExceeded && o.onResultLimitExceeded(l), f;
                    }
                  }
              }
              return f;
            ...
            return S && o && o.onResultLimitExceeded && o.onResultLimitExceeded(l), C;
          }),
          (e.prototype.findDocumentSymbols2 = function (e, t, o) {
            ...
            return k && o && o.onResultLimitExceeded && o.onResultLimitExceeded(l), x;
          }),
          ...
          (e.prototype.getColorPresentations = function (e, t, n, r) {
            ...
            return (
              (o = 1 === n.alpha ? '#' + l(s) + l(c) + l(u) : '#' + l(s) + l(c) + l(u) + l(Math.round(255 * n.alpha))),
  ...
  (function (e) {
    ...
    t.getFoldingRanges = function (e, t) {
        ...
        switch (u) {
          ...
          case 13:
            ...
            1 === c.getTokenError() && h + 1 < e.lineCount
              ...
              : h < m && (l({ startLine: h, endLine: m, kind: r.FoldingRangeKind.Comment }), (s = h));
            break;
          case 12:
            var g = e
              .getText()
            ...
            if (g) {
              ...
              if (g[1]) {
                f = { startLine: p, endLine: p, kind: r.FoldingRangeKind.Region };
                a.push(f);
              } else {
      ...
      for (v = 0; v < o.length; v++) {
        var E;
        'number' == typeof (E = i[v]) && (E < k || (E === k && C++ < y)) && j.push(o[v]);
      }
      return j;
    };
  }),
  ...
  define('vs/language/json/languageFeatures', ['require', 'exports', 'vscode-json-languageservice'], function (
    e,
    t,
    n
  ) {
            ...
            this._worker(e)
              .then(function (n) {
                return n.doValidation(e.toString()).then(function (n) {
                  ...
                  o && o.getModeId() === t && monaco.editor.setModelMarkers(o, t, r);
                });
              })
            ...
            .then(function (o) {
              if (o) {
                var i = e.getWordUntilPosition(t),
                  a = new r(t.lineNumber, i.startColumn, t.lineNumber, i.endColumn),
                  s = o.items.map(function (e) {
                    ...
                    return (
                      e.textEdit && ((t.range = c(e.textEdit.range)), (t.insertText = e.textEdit.newText)),
                      e.additionalTextEdits && (t.additionalTextEdits = e.additionalTextEdits.map(l)),
        ...
        (e.prototype.provideSelectionRanges = function (e, t, n) {
          ...
          return this._worker(r)
            ...
            .then(function (e) {
              if (e)
                return e.map(function (e) {
                  for (var t = []; e; ) t.push({ range: c(e.range) }), (e = e.parent);
                  return t;
                });
            });
        }),
            ...
            return (function (e, o, i, a, s) {
              ...
              for (;;) {
                ...
                if (h === a + d.getPosition())
                  throw new Error('Scanner did not advance, next 3 characters are: ' + o.substr(d.getPosition(), 3));
                switch ((u && (h -= c), (u = c > 0), l)) {
                  ...
                  case 7:
                    ...
                    break;
                  case 10:
                    (m = p ? t.TOKEN_VALUE_STRING : t.TOKEN_PROPERTY_NAME), (p = !1);
                    break;
                  case 11:
    ...
    var r = (function () {
      ...
      return (
        ...
        (e.prototype.equals = function (t) {
          return (
            t === this ||
            (!!(t && t instanceof e) && this.scanError === t.scanError && this.lastWasColon === t.lastWasColon)
          );
        }),
        ...
        function f() {
          ...
          a(c),
            n.documentFormattingEdits &&
              c.push(
                monaco.languages.registerDocumentFormattingEditProvider(t, new r.DocumentFormattingEditProvider(l))
              ),
            ...
            n.completionItems && c.push(monaco.languages.registerCompletionItemProvider(t, new r.CompletionAdapter(l))),
            n.hovers && c.push(monaco.languages.registerHoverProvider(t, new r.HoverAdapter(l))),
            n.documentSymbols &&
              c.push(monaco.languages.registerDocumentSymbolProvider(t, new r.DocumentSymbolAdapter(l))),
            n.tokens && c.push(monaco.languages.setTokensProvider(t, o.createTokenizationSupport(!0))),
            n.colors && c.push(monaco.languages.registerColorProvider(t, new r.DocumentColorAdapter(l))),
            n.foldingRanges && c.push(monaco.languages.registerFoldingRangeProvider(t, new r.FoldingRangeAdapter(l))),
            n.diagnostics && c.push(new r.DiagnosticsAdapter(t, l, e)),
            n.selectionRanges &&
              c.push(monaco.languages.registerSelectionRangeProvider(t, new r.SelectionRangeAdapter(l)));
        }
        f(), t.push(monaco.languages.setLanguageConfiguration(e.languageId, s));
