    ...
    var t = (function () {
        ...
        return (
          (e.prototype.load = function (e, t, i, s) {
            var a = this;
            this._scriptLoader ||
              (this._scriptLoader = this._env.isWebWorker ? new n() : this._env.isNode ? new o(this._env) : new r());
      ...
      o = (function () {
        ...
        return (
            ...
            if (/^node\|/.test(n)) {
              ...
              this._readSourceAndCachedData(f, g, l, function (e, n, a, d) {
                if (e) i(e);
                  ...
                  var l;
                  (l = n.charCodeAt(0) === t._BOM ? t._PREFIX + n.substring(1) + t._SUFFIX : t._PREFIX + n + t._SUFFIX),
                    (l = u(l, f));
          ...
          (t.prototype._createAndEvalScript = function (t, r, n, o, i) {
            ...
            return (
              (c.amd = u.amd),
              d.call(e.global, t.getGlobalAMDRequireFunc(), c, n.filename, this._path.dirname(n.filename)),
            ...
            n &&
              (e.cachedDataRejected ||
                setTimeout(function () {
                  ...
                  n.equals(e) ||
                    (console.warn("FAILED TO VERIFY CACHED DATA. Deleting '" + r + "' now, but a RESTART IS REQUIRED"),
                    o._fs.unlink(r, function (e) {
  ...
  (function (e) {
    ...
    (i.config = o),
      ...
      ('function' == typeof e.global.define && e.global.define.amd) ||
        ((r = new e.ModuleManager(t, e.createScriptLoader(t), n, i, e.Utilities.getHighPerformanceTimestamp())),
