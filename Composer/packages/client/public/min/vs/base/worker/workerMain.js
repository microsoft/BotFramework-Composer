...
(function () {
  ...
  !(function (e) {
          ...
          (n.validateConfigurationOptions = function (n) {
            if (
              ...
              n.nodeCachedData &&
                ...
                ('number' != typeof n.nodeCachedData.writeDelay || n.nodeCachedData.writeDelay < 0) &&
      ...
      var t = (function () {
          ...
          return (
            (e.prototype.load = function (e, t, o, s) {
              var u = this;
              this._scriptLoader ||
                (this._scriptLoader = this._env.isWebWorker ? new r() : this._env.isNode ? new i(this._env) : new n());
        ...
        i = (function () {
          ...
          return (
            ...
            (t.prototype._initNodeRequire = function (e, t) {
              ...
              if (n && !this._didPatchNodeRequire) {
                ...
                i.prototype._compile = function (e, s) {
                  ...
                  return r._handleCachedData(h, a, c, !d.cachedData, t), r._verifyCachedData(h, a, c, u), _;
                };
              }
            }),
              ...
              if (/^node\|/.test(r)) {
                ...
                this._readSourceAndCachedData(h, g, c, function (e, r, u, a) {
                  if (e) o(e);
                    ...
                    var c;
                    (c =
                      r.charCodeAt(0) === t._BOM ? t._PREFIX + r.substring(1) + t._SUFFIX : t._PREFIX + r + t._SUFFIX),
                      (c = l(c, h));
                    var d = { filename: p, cachedData: u },
                      f = s._createAndEvalScript(n, c, d, i, o);
                    s._handleCachedData(f, c, g, m && !u, n), s._verifyCachedData(f, c, g, a);
                  }
                });
              }
            }),
            (t.prototype._createAndEvalScript = function (t, n, r, i, o) {
              ...
              return (
                (d.amd = l.amd),
                a.call(e.global, t.getGlobalAMDRequireFunc(), d, r.filename, this._path.dirname(r.filename)),
                s.record(32, r.filename),
                c ? i() : o(new Error("Didn't receive define call in " + r.filename + '!')),
                u
              );
            }),
            ...
            (t.prototype._verifyCachedData = function (e, t, n, r) {
              var i = this;
              r &&
                (e.cachedDataRejected ||
                  setTimeout(function () {
                    ...
                    r.equals(e) ||
                      (console.warn(
                        "FAILED TO VERIFY CACHED DATA. Deleting '" + n + "' now, but a RESTART IS REQUIRED"
                      ),
                      i._fs.unlink(n, function (e) {
                        return console.error("FAILED to unlink: '" + n + "'", e);
                      }));
    ...
    (function (t) {
      ...
      (s.config = o),
        ...
        ('function' == typeof t.global.define && t.global.define.amd) ||
          ((r = new t.ModuleManager(n, t.createScriptLoader(n), i, s, t.Utilities.getHighPerformanceTimestamp())),
          void 0 !== t.global.require && 'function' != typeof t.global.require && s.config(t.global.require),
          ((e = function () {
            return i.apply(null, arguments);
          }).amd = i.amd),
    ...
    e(n[16], r([0, 1]), function (e, t) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.hash = n), (t.stringHash = i);
    }),
      ...
      var i = (function () {
        ...
        return (
          (e.prototype.getElements = function () {
            for (var e = this.source, t = new Int32Array(e.length), n = 0, r = e.length; n < r; n++)
              t[n] = e.charCodeAt(n);
            return t;
          }),
          e
          ...
          return (
            ...
            (e.prototype.ComputeDiffRecursive = function (e, t, r, i, s) {
              ...
              if (e > t || r > i) {
                ...
                return (
                  r <= i
                    ...
                    : e <= t
                    ? (o.Assert(r === i + 1, 'modifiedStart should only be one more than modifiedEnd'),
              ...
              if (!s[0]) {
                ...
                return (
                  (p = s[0]
                    ? [new n.DiffChange(d + 1, t - (d + 1) + 1, f + 1, i - (f + 1) + 1)]
            ...
            (e.prototype.WALKTRACE = function (e, t, r, i, o, s, a, l, c, d, f, h, p, m, g, v, _, y) {
              ...
              do {
                (P = N + e) === S || (P < L && c[P - 1] < c[P + 1])
                  ...
                  : ((m = (f = c[P - 1] + 1) - N - i),
                    ...
                    (N = P - 1 - e)),
                  A >= 0 && ((e = (c = this.m_forwardHistory[A])[0]), (S = 1), (L = c.length - 1));
              } while (--A >= -1);
              if (((b = E.getReverseChanges()), y[0])) {
                ...
                C = [new n.DiffChange(w, h - w + 1, I, g - I + 1)];
              } else {
                (E = new u()),
                  (S = s),
                  (L = a),
                ...
                do {
                  ...
                  (P = N + o) === S || (P < L && d[P - 1] >= d[P + 1])
                    ...
                    : ((m = (f = d[P - 1]) - N - l),
                      ...
                      (N = P - 1 - o)),
                    A >= 0 && ((o = (d = this.m_reverseHistory[A])[0]), (S = 1), (L = d.length - 1));
                } while (--A >= -1);
                C = E.getChanges();
              }
            ...
            (e.prototype.ComputeRecursionPoint = function (e, t, r, i, o, u, a) {
              ...
              for (var L = 1; L <= m / 2 + 1; L++) {
                ...
                for (var A = d; A <= f; A += 2) {
                  c = (l = A === d || (A < f && v[A - 1] < v[A + 1]) ? v[A + 1] : v[A - 1] + 1) - (A - y) - C;
                  for (var w = l; l < t && c < i && this.ElementsAreEqual(l + 1, c + 1); ) l++, c++;
                  if (((v[A] = l), l + c > N + M && ((N = l), (M = c)), !S && Math.abs(A - b) <= L - 1 && l >= _[A]))
                    return (
                      (o[0] = l),
                      (u[0] = c),
                      w <= _[A] && L <= 1448
                        ? this.WALKTRACE(y, d, f, C, b, h, p, E, v, _, l, t, o, c, i, u, S, a)
                        : null
                    );
                }
                var I = (N - e + (M - r) - L) / 2;
                if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(N, I))
                  return (
                    (a[0] = !0),
                    (o[0] = N),
                    (u[0] = M),
                ...
                for (A = h; A <= p; A += 2) {
                  c = (l = A === h || (A < p && _[A - 1] >= _[A + 1]) ? _[A + 1] - 1 : _[A - 1]) - (A - b) - E;
                  for (w = l; l > e && c > r && this.ElementsAreEqual(l, c); ) l--, c--;
                  if (((_[A] = l), S && Math.abs(A - y) <= L && l <= v[A]))
                    return (
                      (o[0] = l),
                      (u[0] = c),
                      w >= v[A] && L <= 1448
            ...
            (e.prototype.PrettifyChanges = function (e) {
              ...
              for (t = e.length - 1; t >= 0; t--) {
                ...
                if (t > 0) {
                  var a = e[t - 1];
                  a.originalLength > 0 && (r = a.originalStart + a.originalLength),
                    a.modifiedLength > 0 && (i = a.modifiedStart + a.modifiedLength);
                }
            ...
            (e.prototype.ChangesOverlap = function (e, t, r) {
              if (
                (o.Assert(e.originalStart <= t.originalStart, 'Left change is not less than or equal to right change'),
        ...
        return (
          Object.defineProperty(e.prototype, 'value', {
            ...
            set: function (e) {
              this._isDisposed ||
                e === this._value ||
                (this._value && this._value.dispose(), e && i(e), (this._value = e));
            },
            enumerable: !0,
            configurable: !0,
          }),
      ...
      var u = -1,
        ...
        c = (function () {
          function e(e) {
            (this._disposed = !1),
              (this._options = e),
              (this._leakageMon = u > 0 ? new l(this._options && this._options.leakWarningThreshold) : void 0);
          }
          return (
                  ...
                  this._event ||
                    (this._event = function (n, r, s) {
                      ...
                      return (
                        ...
                        s instanceof i.DisposableStore ? s.add(l) : Array.isArray(s) && s.push(l),
                        l
                      );
                    }),
                  this._event
    ...
    e(n[20], r([0, 1]), function (e, t) {
      ...
      function m(e, t) {
        var n = C.getInstance(),
          ...
          i = t,
          o = h(e, r, t),
          s = n.getGraphemeBreakType(o);
        t += o >= 65536 ? 2 : 1;
        for (var u = s; t < r; ) {
          var a = h(e, r, t),
            l = n.getGraphemeBreakType(a);
          if (b(u, l)) break;
          (t += a >= 65536 ? 2 : 1), (u = l);
        }
        var c = t;
      ...
      (t.format = function (e) {
        ...
        (t.getCharContainingOffset = function (e, t) {
          return t > 0 && f(e.charCodeAt(t)) ? m(e, t - 1) : m(e, t);
        });
      ...
      (t.isBasicASCII = function (e) {
        ...
        (t.containsFullWidthCharacter = function (e) {
          for (var t = 0, n = e.length; t < n; t++) if (y(e.charCodeAt(t))) return !0;
          return !1;
        }),
        ...
        (t.breakBetweenGraphemeBreakType = b);
      var C = (function () {
        function e() {
        ...
        d = (function () {
          ...
          return (
            ...
            (e.parse = function (e, t) {
              ...
              var n = c.exec(e);
              return n
                ? new h(n[2] || u, b(n[4] || u), b(n[5] || u), b(n[7] || u), b(n[9] || u), t)
                : new h(u, u, u, u, u);
            }),
            (e.file = function (e) {
              var t = u;
              if ((n.isWindows && (e = e.replace(/\\/g, l)), e[0] === l && e[1] === l)) {
                var r = e.indexOf(l, 2);
                -1 === r ? ((t = e.substring(2)), (e = l)) : ((t = e.substring(2, r)), (e = e.substring(r) || l));
              }
        ...
        if ((i && ((r += i), (r += ':')), (o || 'file' === i) && ((r += l), (r += l)), o)) {
          ...
          if (-1 !== c) {
            ...
            (o = o.substr(c + 1)),
              -1 === (c = d.indexOf(':'))
                ? (r += n(d, !1))
                : ((r += n(d.substr(0, c), !1)), (r += ':'), (r += n(d.substr(c + 1), !1))),
              (r += '@');
          }
        ...
        c = (function (e) {
          function t(t, n, r) {
            ...
            void 0 !== self.require && 'function' == typeof self.require.getConfig
              ...
              : void 0 !== self.requirejs && (a = self.requirejs.s.contexts._.config);
              ...
              if (
                ...
                0 === n.modifiedLength
                  ...
                  : ((h = s.getStartLineNumber(n.modifiedStart)),
                    (p = s.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1))),
                l &&
                  n.originalLength > 0 &&
                  n.originalLength < 20 &&
                  n.modifiedLength > 0 &&
        ...
        c = (function () {
          function e(e, t, n) {
            (this.shouldComputeCharChanges = n.shouldComputeCharChanges),
              ...
              (this.continueCharDiff = h(0 === n.maxComputationTime ? 0 : Math.min(n.maxComputationTime, 5e3)));
          }
          return (
            ...
            (e.prototype._mergeTrimWhitespaceCharChange = function (e, t, n, r, i, o, s) {
              ...
              return (
                ...
                this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new a(t, n, t, r, i, o, i, s)),
                !0)
              );
            }),
            e
            ...
            i[0].indexOf(' ') >= 0
              ? (function (e, t, n, r) {
                  ...
                  for (t.lastIndex = 0; (i = t.exec(n)); ) {
                    var s = i.index || 0;
                    if (s > o) return null;
                    if (t.lastIndex >= o) return { word: i[0], startColumn: r + 1 + s, endColumn: r + 1 + t.lastIndex };
                  }
                  return null;
                })(e, t, n, r)
              : (function (e, t, n, r) {
        ...
        return (
          ...
          (e.computeLinks = function (t, r) {
            ...
            for (
              ...
              for (
                var d = t.getLineContent(l), f = d.length, h = 0, p = 0, m = 0, g = 1, v = !1, _ = !1, y = !1;
                h < f;
 ...
 */
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (function (e) {
          (e[(e.acceptSuggestionOnCommitCharacter = 0)] = 'acceptSuggestionOnCommitCharacter'),
            ...
            (e[(e.copyWithSyntaxHighlighting = 14)] = 'copyWithSyntaxHighlighting'),
            (e[(e.cursorBlinking = 15)] = 'cursorBlinking'),
            (e[(e.cursorSmoothCaretAnimation = 16)] = 'cursorSmoothCaretAnimation'),
            (e[(e.cursorStyle = 17)] = 'cursorStyle'),
            (e[(e.cursorSurroundingLines = 18)] = 'cursorSurroundingLines'),
            (e[(e.cursorSurroundingLinesStyle = 19)] = 'cursorSurroundingLinesStyle'),
            (e[(e.cursorWidth = 20)] = 'cursorWidth'),
            (e[(e.disableLayerHinting = 21)] = 'disableLayerHinting'),
            (e[(e.disableMonospaceOptimizations = 22)] = 'disableMonospaceOptimizations'),
            ...
            (e[(e.highlightActiveIndentGuide = 41)] = 'highlightActiveIndentGuide'),
            (e[(e.hover = 42)] = 'hover'),
            ...
            (e[(e.mouseWheelScrollSensitivity = 54)] = 'mouseWheelScrollSensitivity'),
            (e[(e.mouseWheelZoom = 55)] = 'mouseWheelZoom'),
            (e[(e.multiCursorMergeOverlapping = 56)] = 'multiCursorMergeOverlapping'),
            ...
            (e[(e.revealHorizontalRightPadding = 71)] = 'revealHorizontalRightPadding'),
            ...
            (e[(e.suggestOnTriggerCharacters = 88)] = 'suggestOnTriggerCharacters'),
            ...
            (e[(e.wordWrapBreakAfterCharacters = 94)] = 'wordWrapBreakAfterCharacters'),
            (e[(e.wordWrapBreakBeforeCharacters = 95)] = 'wordWrapBreakBeforeCharacters'),
            (e[(e.wordWrapBreakObtrusiveCharacters = 96)] = 'wordWrapBreakObtrusiveCharacters'),
  ...
  e(n[34], r([0, 1, 13, 6, 7, 4, 12, 2, 5, 24, 31, 25, 26, 27, 29, 10]), function (
    e,
    t,
    n,
    r,
                ...
                return (
                  ...
                  i && o
                    ? ((s = i.getLinesContent()),
                      ...
                      (l = a.computeDiff()),
                      (d = !(l.changes.length > 0) && this._modelsAreIdentical(i, o)),
                      [2, { quitEarly: l.quitEarly, identical: d, changes: l.changes }])
                    : [2, null]
                );
              });
            });
              ...
              return c(this, function (c) {
                ...
                for (
                  ...
                  if (
                    ...
                    (!d.Range.isEmpty(h) || p) &&
                      ((g = o.getValueInRange(h)), (p = p.replace(/\r\n|\n|\r/g, o.eol)), g !== p))
                  )
                    if (Math.max(p.length, g.length) > t._diffLimit)
                      ...
                      for (
                        v = r.stringDiff(g, p, !1), _ = o.offsetAt(d.Range.lift(h).getStartPosition()), y = 0, b = v;
                        y < b.length;
                        y++
                      )
                        (C = b[y]),
                          (E = o.positionAt(_ + C.originalStart)),
                          (S = o.positionAt(_ + C.originalStart + C.originalLength)),
                          (L = {
              ...
              return c(this, function (c) {
                ...
                for (
                  s = [],
                    u = new Set(),
                    a = new RegExp(r, i),
                    (l = o.getWordAtPosition(n, a)) && u.add(o.getValueInRange(l)),
                    d = o.createWordIterator(a),
                    f = d.next();
                  !f.done && u.size <= t._suggestionsLimit;
                  f = d.next()
                )
                  (h = f.value), u.has(h) || (u.add(h), isNaN(Number(h)) && s.push(h));
                return [2, s];
              });
            });
          }),
            ...
            return l(this, void 0, void 0, function () {
              ...
              return c(this, function (c) {
                ...
                for (o = new RegExp(n, r), s = Object.create(null), u = t.startLineNumber; u < t.endLineNumber; u++)
                  for (a = i.getLineWords(u, o), l = 0, d = a; l < d.length; l++)
                    (f = d[l]),
                      isNaN(Number(f.word)) &&
                  ...
                  ? ((s = new RegExp(r, i)),
                    ...
                    (a = o.getWordAtPosition(
                      ...
                      ? ((l = o.getValueInRange(a)),
                        [2, g.BasicInplaceReplace.INSTANCE.navigateValueSet(t, u, a, l, n)])
                      : [2, null])
                  : [2, null];
              });
            });
