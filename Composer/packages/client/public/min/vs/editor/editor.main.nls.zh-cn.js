...
define('vs/editor/editor.main.nls.zh-cn', {
  ...
  'vs/base/parts/quickopen/browser/quickOpenWidget': ['快速选取器。键入以缩小结果范围。', '快速选取器', '{0} 个结果'],
  'vs/editor/browser/controller/coreCommands': ['全选(&&S)', '撤消(&&U)', '恢复(&&R)'],
  'vs/editor/browser/controller/textAreaHandler': ['现在无法访问编辑器。按 Alt+F1  显示选项。'],
  ...
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['解析文件失败。', '{0} 个引用', '{0} 个引用'],
  'vs/editor/contrib/gotoSymbol/peek/referencesWidget': ['无可用预览', '引用', '无结果', '引用'],
  ...
  'vs/editor/contrib/suggest/suggestController': ['选择“{0}”后进行了其他 {1} 次编辑', '触发建议'],
  ...
  'vs/editor/contrib/tokenization/tokenization': ['开发者: 强制重新进行标记'],
