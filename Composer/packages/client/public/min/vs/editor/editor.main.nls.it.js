...
define('vs/editor/editor.main.nls.it', {
  ...
  'vs/base/browser/ui/aria/aria': ['{0} (nuova occorrenza)', '{0} ( accaduto {1} volte)'],
  ...
  'vs/base/browser/ui/inputbox/inputBox': ['Errore: {0}', 'Avviso: {0}', 'Informazioni: {0}'],
  'vs/base/browser/ui/keybindingLabel/keybindingLabel': ['Non associato'],
  'vs/base/browser/ui/list/listWidget': ['{0}. utilizzare i tasti di navigazione per navigare.'],
  ...
  'vs/editor/browser/controller/coreCommands': ['&&Seleziona tutto', '&&Annulla', '&&Ripeti'],
