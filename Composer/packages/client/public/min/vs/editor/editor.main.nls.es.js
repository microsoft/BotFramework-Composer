...
define('vs/editor/editor.main.nls.es', {
  ...
  'vs/base/browser/ui/aria/aria': ['{0} (ocurrió de nuevo)', '{0} (ocurrido {1} veces)'],
  ...
  'vs/base/browser/ui/list/listWidget': ['{0}. Para navegar utilice las teclas de navegación.'],
  ...
  'vs/editor/browser/controller/coreCommands': ['&&Seleccionar todo', '&&Deshacer', '&&Rehacer'],
