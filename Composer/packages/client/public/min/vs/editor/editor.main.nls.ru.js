...
define('vs/editor/editor.main.nls.ru', {
  ...
  'vs/base/browser/ui/aria/aria': ['{0} (произошло снова)', '{0} (было {1} раз)'],
  ...
  'vs/base/browser/ui/list/listWidget': ['{0}. Для перехода используйте клавиши навигации.'],
  ...
  'vs/editor/browser/controller/coreCommands': ['&&Выделить все', '&&Отменить', '&&Повторить'],
  ...
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['Не удалось разрешить файл.', 'Ссылок: {0}', '{0} ссылка'],
