...
define('vs/editor/editor.main.nls.fr', {
  ...
  'vs/base/browser/ui/aria/aria': ["{0} (s'est reproduit)", '{0} (survenu {1} fois)'],
  ...
  'vs/base/browser/ui/list/listWidget': ['{0}. Utiliser les touches de navigation pour naviguer.'],
  ...
  'vs/editor/browser/controller/coreCommands': ['&&Sélectionner tout', 'Ann&&uler', '&&Rétablir'],
