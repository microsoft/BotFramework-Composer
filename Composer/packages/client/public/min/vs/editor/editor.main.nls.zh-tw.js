...
define('vs/editor/editor.main.nls.zh-tw', {
  ...
  'vs/base/parts/quickopen/browser/quickOpenWidget': ['快速選擇器。輸入以縮小結果範圍。', '快速選擇器', '{0} 個結果'],
  'vs/editor/browser/controller/coreCommands': ['全選(&&S)', '復原(&&U)', '取消復原(&&R)'],
  'vs/editor/browser/controller/textAreaHandler': ['編輯器現在無法存取。按Alt+F1尋求選項'],
  ...
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['無法解析檔案。', '{0} 個參考', '{0} 個參考'],
  'vs/editor/contrib/gotoSymbol/peek/referencesWidget': ['無法預覽', '參考', '查無結果', '參考'],
  ...
  'vs/editor/contrib/suggest/suggestController': ['接受 ‘{0}’ 進行了其他 {1} 項編輯', '觸發建議'],
