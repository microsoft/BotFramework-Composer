...
define('vs/editor/editor.main.nls.de', {
  ...
  'vs/base/browser/ui/aria/aria': ['{0} (erneut aufgetreten)', '{0} ({1} mal aufgetretenen)'],
  ...
  'vs/base/browser/ui/list/listWidget': ['{0}. Verwenden Sie die Navigationstasten, um zu navigieren.'],
  ...
  'vs/editor/browser/controller/coreCommands': ['&&Alles auswählen', '&&Rückgängig', '&&Wiederholen'],
