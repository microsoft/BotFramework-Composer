...
define('vs/editor/editor.main.nls.ko', {
  ...
  'vs/base/browser/ui/list/listWidget': ['{0}. 탐색하려면 탐색 키를 사용하세요.'],
  ...
  'vs/editor/browser/controller/coreCommands': ['모두 선택(&&S)', '실행 취소(&&U)', '다시 실행(&&R)'],
  'vs/editor/browser/controller/textAreaHandler': ['지금은 편집기를 사용할 수 없습니다. Alt+F1을 눌러 옵션을 보세요.'],
  ...
  'vs/editor/contrib/gotoSymbol/peek/referencesTree': ['파일을 확인하지 못했습니다.', '참조 {0}개', '참조 {0}개'],
  'vs/editor/contrib/gotoSymbol/peek/referencesWidget': ['미리 보기를 사용할 수 없음', '참조', '결과 없음', '참조'],
  ...
  'vs/editor/contrib/suggest/suggestController': ['{0}의 {1}개의 수정사항을 수락하는 중', '제안 항목 트리거'],
