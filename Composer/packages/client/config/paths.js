...
module.exports = {
  ...
  appPath: resolveApp('.'),
  appBuild: resolveApp('build/public'), // resolveApp('../server/build/public'),
  appDist: resolveApp('dist'),
  appDistElectron: resolveApp('../electron-server/dist'),
  ...
  proxySetup: resolveModule(resolveApp, 'setupProxy'),
