...
import { IfCondition } from '@botframework-composer/types';
...
export async function copyIfCondition(input: IfCondition, externalApi: ExternalApi): Promise<IfCondition> {
