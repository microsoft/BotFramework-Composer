...
describe('lgUtils', () => {
  describe('computePropertyItemTree', () => {
    it('should return item tree', () => {
      const itemTree = computePropertyItemTree(['dialog.turnCount', 'dialog.value', 'user.name', 'this.value']);
      expect(itemTree).toEqual(
  ...
  describe('getAllNodes', () => {
    ...
    it('should return node paths by id', () => {
    ...
    it('should return node levels by id', () => {
