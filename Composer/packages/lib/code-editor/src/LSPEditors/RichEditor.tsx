...
import { BaseEditorCore, BaseEditorCoreProps } from './BaseEditorCore';

export interface RichEditorProps extends BaseEditorCoreProps {
...
export function RichEditor(props: RichEditorProps) {
  ...
  return (
    <Fragment>
      ...
      >
        <BaseEditorCore {...rest} placeholder={hidePlaceholder ? undefined : placeholder} />
      </div>
      {isInvalid && (
