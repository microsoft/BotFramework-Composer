...
export const shouldBeRuleDialog: TraceableBeforeHandler<ObiRuleDialog> = (obi: ObiRuleDialog): boolean => {
  return obi.$type === DialogTypes.RuleDialog;
};

export const shouldBeSequenceDialog: TraceableBeforeHandler<ObiRuleDialog> = (obi: ObiRuleDialog): boolean => {
