...
export class TransformableView extends React.Component<TransformableViewProps, TransformableViewState> {
            ...
            return (
                <div className="transformable-view">
                    <div
                        ...
                        <div className={`boundary ${Constants.transformInteractiveZoneClassName}`} ref={this.contentBoundaryElement}>
                            <div className={`${TRANSFORM_TARGET_CLASS_NAME} ${Constants.transformInteractiveZoneClassName}`} ref={this.transformTargetElement}>
                                {this.props.children}
                            </div>
                        </div>
                    </div>
    ...
    private renderMiniMap(): React.ReactNode {
        if (!this.viewRootElement.current
            || !this.transformTargetElement.current
    ...
    private updateContentBoundary(): void {
        ...
        this.contentBoundaryElement.current.style.width = `${this.transformTargetElement.current.scrollWidth * this.transformParams.scale}px`;
        this.contentBoundaryElement.current.style.height = `${this.transformTargetElement.current.scrollHeight * this.transformParams.scale}px`;
    }
