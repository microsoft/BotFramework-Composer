...
function dfsRank(currentId: string, currentRank: number, rankMap: StringMap<number>, layoutGraph: Dagre.graphlib.Graph, visitedIds: Set<string>): void {
...
function sortNodes(rankList: RankGroup[], layoutGraph: Dagre.graphlib.Graph, ancestorMap: StringMap<Set<string>>): void {
    for (const currentGroup of rankList) {
        ...
        currentGroup.nodeIds.sort((node0, node1) => sortByBasisRank(node0, node1, currentGroupIndex, rankList, layoutGraph, ancestorMap));
    }
}

function sortByBasisRank(node0: string, node1: string, currentGroupIndex: number, rankList: RankGroup[], layoutGraph: Dagre.graphlib.Graph, ancestorMap: StringMap<Set<string>>): number {
...
function positionNodes(rankList: RankGroup[], layoutGraph: Dagre.graphlib.Graph, ancestorMap: StringMap<Set<string>>, bbox: BoundingBox, options: LayoutOptions): void {
...
function assignCompactCoords(rankGroup: RankGroup, layoutGraph: Dagre.graphlib.Graph, flexDirectionOffset: number): number {
...
function alignCoords(referenceGroupIndex: number, rankList: RankGroup[], layoutGraph: Dagre.graphlib.Graph, ancestorMap: StringMap<Set<string>>): void {
...
function alignCoordsByReferenceRank(adjustmentGroup: RankGroup, referenceGroup: RankGroup, layoutGraph: Dagre.graphlib.Graph, ancestorMap: StringMap<Set<string>>): void {
...
function computeAncestorMap(rankList: RankGroup[], rankMap: StringMap<number>, layoutGraph: Dagre.graphlib.Graph): StringMap<Set<string>> {
