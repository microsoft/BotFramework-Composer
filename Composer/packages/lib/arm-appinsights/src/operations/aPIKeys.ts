...
export class APIKeys {
  ...
  list(
    resourceGroupName: string,
    resourceName: string,
    options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ApplicationInsightsComponentAPIKeyListResult>,
    callback?: msRest.ServiceCallback<Models.ApplicationInsightsComponentAPIKeyListResult>
  ): Promise<Models.APIKeysListResponse> {
  ...
  create(
    ...
    resourceName: string,
    aPIKeyProperties: Models.APIKeyRequest,
    options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ApplicationInsightsComponentAPIKey>,
    callback?: msRest.ServiceCallback<Models.ApplicationInsightsComponentAPIKey>
  ): Promise<Models.APIKeysCreateResponse> {
    return this.client.sendOperationRequest(
      {
...
const deleteMethodOperationSpec: msRest.OperationSpec = {
  ...
  urlParameters: [Parameters.resourceGroupName, Parameters.subscriptionId, Parameters.resourceName, Parameters.keyId],
  queryParameters: [Parameters.apiVersion],
  headerParameters: [Parameters.acceptLanguage],
  responses: {
    200: {
