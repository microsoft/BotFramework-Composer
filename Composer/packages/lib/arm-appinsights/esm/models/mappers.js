...
export var ApplicationInsightsComponent = {
  ...
  type: {
    ...
    modelProperties: __assign(__assign({}, ComponentsResource.type.modelProperties), {
      kind: {
        required: true,
        serializedName: 'kind',
        type: {
...
export var WebTest = {
  ...
  type: {
    name: 'Composite',
    className: 'WebTest',
    modelProperties: __assign(__assign({}, WebtestsResource.type.modelProperties), {
      kind: {
        serializedName: 'kind',
        defaultValue: 'ping',
        type: {
...
export var Workbook = {
  ...
  type: {
    name: 'Composite',
    className: 'Workbook',
    modelProperties: __assign(__assign({}, WorkbookResource.type.modelProperties), {
      kind: {
        serializedName: 'kind',
        type: {
          name: 'String',
