...
var ProactiveDetectionConfigurations = /** @class */ (function () {
  ...
  ProactiveDetectionConfigurations.prototype.get = function (
    resourceGroupName,
    resourceName,
    configurationId,
    options,
  ...
  ProactiveDetectionConfigurations.prototype.update = function (
    resourceGroupName,
    resourceName,
    configurationId,
...
var updateOperationSpec = {
  ...
  requestBody: {
    ...
    mapper: __assign(__assign({}, Mappers.ApplicationInsightsComponentProactiveDetectionConfiguration), {
      required: true,
    }),
  },
  responses: {
