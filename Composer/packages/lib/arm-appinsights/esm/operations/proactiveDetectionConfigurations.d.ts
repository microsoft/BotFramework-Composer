...
export declare class ProactiveDetectionConfigurations {
  ...
  list(
    resourceGroupName: string,
    resourceName: string,
    callback: msRest.ServiceCallback<Models.ApplicationInsightsComponentProactiveDetectionConfiguration[]>
  ): void;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param resourceName The name of the Application Insights component resource.
  ...
  update(
    ...
    resourceName: string,
    configurationId: string,
    proactiveDetectionProperties: Models.ApplicationInsightsComponentProactiveDetectionConfiguration,
    options?: msRest.RequestOptionsBase
