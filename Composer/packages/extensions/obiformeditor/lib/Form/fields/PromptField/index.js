...
export var PromptField = function(props) {
  ...
  var promptSettingsIdSchema = { __id: props.idSchema.__id + 'promptSettings' };
  ...
  return jsx(
    ...
    jsx(
      'div',
      { className: 'ObjectItem ObjectItemContainer', css: settingsContainer },
      jsx(
        'div',
        { className: 'ObjectItemField' },
        jsx(
          BaseField,
          {
