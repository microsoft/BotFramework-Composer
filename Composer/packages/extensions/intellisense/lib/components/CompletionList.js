...
exports.CompletionList = react_1.default.forwardRef(function (props, ref) {
  var completionItems = props.completionItems,
    selectedItem = props.selectedItem,
    onClickCompletionItem = props.onClickCompletionItem;
  return core_1.jsx(
    'div',
    { ref: ref, css: styles.completionList },
    completionItems.map(function (completionItem, index) {
      return core_1.jsx(CompletionElement_1.CompletionElement, {
        key: index,
        completionItem: completionItem,
        isSelected: selectedItem === index,
        onClickCompletionItem: function () {
          return onClickCompletionItem(index);
        },
      });
    })
  );
