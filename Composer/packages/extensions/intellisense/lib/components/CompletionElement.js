...
var styles = {
    completionElement: core_1.css(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n    height: 32px;\n    cursor: pointer;\n    padding: 0 4px;\n    width: 100%;\n    display: flex;\n    align-items: center;\n  "], ["\n    height: 32px;\n    cursor: pointer;\n    padding: 0 4px;\n    width: 100%;\n    display: flex;\n    align-items: center;\n  "]))),
    selectedElement: core_1.css(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n    background-color: #ddd;\n  "], ["\n    background-color: #ddd;\n  "]))),
    text: core_1.css(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n    font-size: 15px;\n  "], ["\n    font-size: 15px;\n  "]))),
    icon: core_1.css(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["\n    margin-right: 5px;\n  "], ["\n    margin-right: 5px;\n  "]))),
};
...
var renderMatch = function (match, segmentIndex) {
    ...
    var items = match.indices.map(function (m, spanIndex) {
        ...
        firstIndex = m[1] + 1;
        return (core_1.jsx(react_1.default.Fragment, { key: "segment-" + segmentIndex + "-span-" + spanIndex },
            firstSpan,
            secondSpan));
    });
    items.push(core_1.jsx("span", { key: "segment-" + segmentIndex + "-span-final" }, match.value.slice(firstIndex, lastIndex)));
...
exports.CompletionElement = function (props) {
    var completionItem = props.completionItem, isSelected = props.isSelected, onClickCompletionItem = props.onClickCompletionItem;
    var additionalStyles = isSelected ? styles.selectedElement : {};
    var renderItem = function () {
        return (core_1.jsx("div", { css: [styles.completionElement, additionalStyles], onClick: onClickCompletionItem },
            core_1.jsx(Icon_1.FontIcon, { iconName: getIconName(completionItem.kind), css: styles.icon }),
            core_1.jsx("div", { css: styles.text }, completionItem.data.matches
                ? renderLabelWithCharacterHighlights(completionItem.data.matches)
                : completionItem.label)));
    };
    return completionItem.documentation ? (core_1.jsx(Tooltip_1.TooltipHost, { content: renderDocumentation(completionItem.documentation), directionalHint: Tooltip_1.DirectionalHint.rightCenter }, renderItem())) : (renderItem());
};
