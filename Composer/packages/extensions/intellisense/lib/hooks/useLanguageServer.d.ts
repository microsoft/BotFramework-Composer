 ...
 */
export declare const useLanguageServer: (url: string, scopes: string[], documentUri: string, textFieldValue: string, cursorPosition: number, projectId?: string | undefined) => CompletionItem[];
