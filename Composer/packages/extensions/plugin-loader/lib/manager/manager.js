...
function getExtensionMetadata(extensionPath, packageJson) {
    ...
    return {
        id: packageJson.name,
        name: (_b = (_a = packageJson.composer) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : packageJson.name,
        version: packageJson.version,
        enabled: true,
        path: extensionPath,
        bundles: processBundles(extensionPath, (_d = (_c = packageJson.composer) === null || _c === void 0 ? void 0 : _c.bundles) !== null && _d !== void 0 ? _d : []),
        contributes: (_f = (_e = packageJson.composer) === null || _e === void 0 ? void 0 : _e.contributes) !== null && _f !== void 0 ? _f : {},
    };
}
class PluginManager {
    constructor() {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const p in plugins) {
                ...
                if (packageJson && (!!packageJson.composer || !!packageJson.extendsComposer)) {
                    ...
                    this.manifest.updateExtensionConfig(packageJson.name, Object.assign(Object.assign({}, metadata), { builtIn: true }));
                ...
                if (Array.isArray(result)) {
                    result.forEach((searchResult) => {
                        ...
                        if (keywords.includes('botframework-composer')) {
                            const url = (_a = links === null || links === void 0 ? void 0 : links.npm) !== null && _a !== void 0 ? _a : '';
