...
<<<<<<< HEAD:Composer/packages/extensions/visual-designer/src/adaptive-sdk/widgets/StepEditor.tsx
...
=======
    ...
    <StepGroup
>>>>>>> master:Composer/packages/extensions/visual-designer/src/editors/StepEditor.tsx
      data={data}
      id={id}
      onEvent={onEvent}
      onResize={(boundary) => {
