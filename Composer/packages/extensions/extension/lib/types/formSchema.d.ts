...
declare type UIOptionValue<R = string, D = any> = R | UIOptionFunc<R, D>;
declare type UIOptionFunc<R, D> = (data: D) => R;
...
export declare type RoleSchema = {
    [key in SDKRoles]?: Omit<UIOptions, 'properties'>;
};
export declare type FormUISchema = {
    [key in SDKKinds]?: UIOptions;
};
export declare type RecognizerSchema = {
    ...
    renameIntent: (intentName: string, newIntentName: string, shellData: ShellData, shellApi: ShellApi) => Promise<void> | void;
};
export {};
