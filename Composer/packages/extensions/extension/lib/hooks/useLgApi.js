...
exports.useLgApi = function (shellApi) {
  var removeLgTemplates = shellApi.removeLgTemplates,
  ...
  var readLgTemplate = function (lgFileId, lgText) {
    ...
    var targetTemplate = lgTemplates.find(function (x) {
      return x.name === inputLgRef.name;
    });
    return targetTemplate ? targetTemplate.body : lgText;
  };
  var createLgTemplate = function (lgFileId, lgText, hostActionId, hostActionData, hostFieldName) {
    return tslib_1.__awaiter(void 0, void 0, void 0, function () {
      var newLgType, newLgTemplateName, newLgTemplateRefStr;
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!lgText) return [2 /*return*/, ''];
  ...
  return {
    ...
    deleteLgTemplate: function (lgFileId, lgTemplate) {
      return deleteLgTemplates(lgFileId, [lgTemplate]);
    },
