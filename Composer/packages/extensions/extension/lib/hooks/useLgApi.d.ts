 ...
 * LG CRUD lib
 */
export declare const useLgApi: (shellApi: ShellApi) => {
    createLgTemplate: (lgFileId: string, lgText: string, hostActionId: string, hostActionData: BaseSchema, hostFieldName: string) => Promise<string>;
