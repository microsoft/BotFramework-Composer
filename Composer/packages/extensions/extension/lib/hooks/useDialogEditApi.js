...
var appendNodesAfter = shared_1.DialogUtils.appendNodesAfter,
  queryNodes = shared_1.DialogUtils.queryNodes,
  insertNodes = shared_1.DialogUtils.insertNodes,
  deleteNode = shared_1.DialogUtils.deleteNode,
  deleteNodes = shared_1.DialogUtils.deleteNodes;
function useDialogEditApi(shellApi) {
  var _a = useActionApi_1.useActionApi(shellApi),
    constructActions = _a.constructActions,
    copyActions = _a.copyActions,
    deleteAction = _a.deleteAction,
    deleteActions = _a.deleteActions;
  function insertActions(dialogId, dialogData, targetArrayPath, targetArrayPosition, actionsToInsert) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, constructActions(dialogId, actionsToInsert)];
          case 1:
            newNodes = _a.sent();
  ...
  function insertAction(dialogId, dialogData, targetArrayPath, targetArrayPosition, actionToInsert) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      return tslib_1.__generator(this, function (_a) {
        return [
          2 /*return*/,
          insertActions(dialogId, dialogData, targetArrayPath, targetArrayPosition, [actionToInsert]),
        ];
      });
    });
  }
  ...
  function deleteSelectedAction(dialogId, dialogData, actionId) {
    return deleteNode(dialogData, actionId, function (node) {
      return deleteAction(dialogId, node);
    });
  }
  ...
  function cutSelectedActions(dialogId, dialogData, actionIds) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, copySelectedActions(dialogId, dialogData, actionIds)];
          case 1:
            cutActions = _a.sent();
