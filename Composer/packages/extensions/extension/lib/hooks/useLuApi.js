...
exports.useLuApi = function (shellApi) {
  var addLuIntent = shellApi.addLuIntent,
    removeLuIntent = shellApi.removeLuIntent,
    getLuIntent = shellApi.getLuIntent;
  var createLuIntent = function (luFildId, intent, hostResourceId, hostResourceData) {
    return tslib_1.__awaiter(void 0, void 0, void 0, function () {
      var newLuIntentType, newLuIntentName, newLuIntent;
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!intent) return [2 /*return*/];
  ...
  var deleteLuIntents = function (luFileId, luIntents) {
    return Promise.all(
      luIntents.map(function (intent) {
        return removeLuIntent(luFileId, intent);
      })
    );
  };
  return {
    ...
    deleteLuIntent: function (luFileId, luIntent) {
      return deleteLuIntents(luFileId, [luIntent]);
    },
