...
export declare function useDialogEditApi(shellApi: ShellApi): {
    insertAction: (dialogId: string, dialogData: any, targetArrayPath: string, targetArrayPosition: number, actionToInsert: BaseSchema) => Promise<any>;
    insertActions: (dialogId: string, dialogData: any, targetArrayPath: string, targetArrayPosition: number, actionsToInsert: BaseSchema[]) => Promise<any>;
    insertActionsAfter: (dialogId: string, dialogData: any, targetId: string, actionsToInsert: BaseSchema[]) => Promise<any>;
    ...
    cutSelectedActions: (dialogId: any, dialogData: any, actionIds: string[]) => Promise<{
        dialog: any;
        cutActions: any[];
    }>;
