 ...
 * LU CRUD API
 */
export declare const useLuApi: (shellApi: ShellApi) => {
    createLuIntent: (luFildId: string, intent: LuIntentSection | undefined, hostResourceId: string, hostResourceData: BaseSchema) => Promise<string | undefined>;
