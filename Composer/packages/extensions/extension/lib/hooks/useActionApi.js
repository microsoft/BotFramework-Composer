...
exports.useActionApi = function (shellApi) {
    var _a = useLgApi_1.useLgApi(shellApi), createLgTemplate = _a.createLgTemplate, readLgTemplate = _a.readLgTemplate, deleteLgTemplates = _a.deleteLgTemplates;
    var _b = useLuApi_1.useLuApi(shellApi), createLuIntent = _b.createLuIntent, readLuIntent = _b.readLuIntent, deleteLuIntents = _b.deleteLuIntents;
    var luFieldName = '_lu';
    ...
    function constructActions(dialogId, actions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                referenceLgText = function (fromId, fromAction, toId, toAction, lgFieldName) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                    return [2 /*return*/, createLgTemplate(dialogId, fromAction[lgFieldName], toId, toAction, lgFieldName)];
                }); }); };
                referenceLuIntent = function (fromId, fromAction, toId, toAction) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    var _a;
    ...
    function copyActions(dialogId, actions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                dereferenceLg = function (fromId, fromAction, toId, toAction, lgFieldName) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                    return [2 /*return*/, readLgTemplate(dialogId, fromAction[lgFieldName])];
                }); }); };
                dereferenceLu = function (fromId, fromAction, toId, toAction) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    var luValue;
                    return tslib_1.__generator(this, function (_a) {
    ...
    function constructAction(dialogId, action) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, constructActions(dialogId, [action])];
    ...
    function copyAction(dialogId, action) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, copyActions(dialogId, [action])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    function deleteAction(dialogId, action) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, shared_1.deleteAction(action, function (templates) { return deleteLgTemplates(dialogId, templates); }, function (luIntents) { return deleteLuIntents(dialogId, luIntents); })];
            });
        });
    }
    function deleteActions(dialogId, actions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, shared_1.deleteActions(actions, function (templates) { return deleteLgTemplates(dialogId, templates); }, function (luIntents) { return deleteLuIntents(dialogId, luIntents); })];
            });
        });
    }
    return {
