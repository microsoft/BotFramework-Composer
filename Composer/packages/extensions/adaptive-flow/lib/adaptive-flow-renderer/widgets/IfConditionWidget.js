...
var calculateIfElseLayout = function (nodeMap) {
    var conditionNode = nodeMap.conditionNode, choiceNode = nodeMap.choiceNode, ifBranchNode = nodeMap.ifBranchNode, elseBranchNode = nodeMap.elseBranchNode;
...
export var IfConditionWidget = function (_a) {
    ...
    var _b = useSmartLayout(nodeMap, calculateIfElseLayout, onResize), layout = _b.layout, updateNodeBoundary = _b.updateNodeBoundary;
    var boundary = layout.boundary, edges = layout.edges;
    var conditionNode = nodeMap.conditionNode, choiceNode = nodeMap.choiceNode;
    return (jsx("div", { css: { width: boundary.width, height: boundary.height, position: 'relative' } },
        ...
        jsx(OffsetContainer, { offset: conditionNode.offset },
            jsx(NodeWrapper, { nodeData: data, nodeId: conditionNode.id, onEvent: onEvent },
        ...
        jsx(OffsetContainer, { offset: choiceNode.offset },
            jsx(Diamond, { onClick: function () {
        ...
        [IfElseNodes.IfBranch, IfElseNodes.ElseBranch].map(function (nodeName) {
            ...
            return (jsx(OffsetContainer, { key: node.id + "/offset", offset: node.offset },
                jsx(ActionGroup, { key: node.id, data: node.data, id: node.id, onEvent: onEvent, onResize: function (size) {
