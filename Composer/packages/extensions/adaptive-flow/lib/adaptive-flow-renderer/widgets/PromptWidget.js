...
export var PromptWidget = function (_a) {
  ...
  return jsx(
    ...
    jsx(
      ...
      jsx(
        NodeWrapper,
        { nodeData: data, nodeId: botAsksNode.id, nodeTab: PromptTab.BOT_ASKS, onEvent: onEvent },
        jsx(
          ElementMeasurer,
          {
    ...
    jsx(
      ...
      jsx(
        NodeWrapper,
        { nodeData: data, nodeId: userAnswersNode.id, nodeTab: PromptTab.USER_INPUT, onEvent: onEvent },
        jsx(
          ElementMeasurer,
          {
            onResize: function (boundary) {
    ...
    jsx(
      ...
      jsx(
        NodeWrapper,
        { nodeData: data, nodeId: brickNode.id, nodeTab: PromptTab.OTHER, onEvent: onEvent },
        jsx(IconBrick, {
