...
export var StepRenderer = function (_a) {
    ...
    var _b = useContext(SchemaContext), widgets = _b.widgets, schemaProvider = _b.schemaProvider;
    ...
    return (jsx(NodeWrapper, { nodeData: data, nodeId: id, onEvent: onEvent },
        jsx(ElementMeasurer, { onResize: function (boundary) { return onResize(boundary); } }, content)));
};
