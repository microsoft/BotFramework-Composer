...
export var ArrowLine = function (_a) {
    var width = _a.width, arrowsize = _a.arrowsize, color = _a.color;
    var points = [
        { x: 0, y: 0 },
    ...
    var pointsString = points.map(function (p) { return p.x + "," + p.y; }).join(' ');
    return (jsx("svg", { css: { display: 'block' }, height: 1, overflow: "visible", width: width },
