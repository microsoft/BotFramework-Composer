...
export var ElementMeasurer = function (_a) {
    var children = _a.children, style = _a.style, onResize = _a.onResize;
    return (React.createElement(Measure, { bounds: true, onResize: function (_a) {
            var _b = _a.bounds, width = _b.width, height = _b.height;
            /**
