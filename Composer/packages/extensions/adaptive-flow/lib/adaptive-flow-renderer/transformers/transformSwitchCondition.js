...
export function transformSwitchCondition(input, jsonpath) {
    var _a;
    if (!input || input.$kind !== AdaptiveKinds.SwitchCondition)
        return null;
    ...
    result.branches.push(new IndexedNode(jsonpath + "." + DefaultBranchKey, {
    ...
    if (!cases || !Array.isArray(cases))
        return result;
    (_a = result.branches).push.apply(_a, cases.map(function (_a, index) {
        var value = _a.value, actions = _a.actions;
