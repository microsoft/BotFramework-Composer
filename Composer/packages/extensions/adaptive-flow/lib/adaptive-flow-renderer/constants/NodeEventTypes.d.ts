export declare enum NodeEventTypes {
...
export declare type EditorEventHandler = (eventType: NodeEventTypes, eventData: any) => any;
//# sourceMappingURL=NodeEventTypes.d.ts.map
