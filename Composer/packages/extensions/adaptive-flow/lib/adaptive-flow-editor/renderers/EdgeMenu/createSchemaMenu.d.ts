...
export declare const createActionMenu: (onClick: ActionMenuItemClickHandler, options: ActionMenuOptions, menuSchema?: MenuUISchema | undefined, customActionGroups?: DefinitionSummary[][] | undefined) => IContextualMenuItem[];
export {};
