...
export var VisualEditorEdgeMenu = function (_a) {
  var arrayId = _a.arrayId,
    arrayPosition = _a.arrayPosition,
    onEvent = _a.onEvent;
  return React.createElement(EdgeMenu, {
    id: arrayId + '[' + arrayPosition + ']',
    onClick: function ($kind) {
      return onEvent(NodeEventTypes.Insert, { id: arrayId, position: arrayPosition, $kind: $kind });
    },
  });
};
export var VisualEditorNodeWrapper = function (_a) {
  var nodeId = _a.nodeId,
    nodeData = _a.nodeData,
    nodeTab = _a.nodeTab,
    onEvent = _a.onEvent,
    children = _a.children;
  return React.createElement(
    ActionNodeWrapper,
    { data: nodeData, id: nodeId, tab: nodeTab, onEvent: onEvent },
    children
  );
};
