...
var VisualDesigner = function (_a) {
  ...
  var _c = useShellApi(),
    ...
    shellData = __rest(_c, ['shellApi']);
  var _d = useFlowUIOptions(),
    schemaFromPlugins = _d.schema,
    widgetsFromPlugins = _d.widgets;
  ...
  // Compute schema diff
  var customActionSchema = useMemo(
    function () {
      var _a;
  ...
  var _e = useSelectionEffect({ data: data, nodeContext: nodeContext }, shellApi),
    selection = _e.selection,
    selectionContext = __rest(_e, ['selection']);
  var handleEditorEvent = useEditorEventApi(
    { path: dialogId, data: data, nodeContext: nodeContext, selectionContext: selectionContext },
    shellApi
  ).handleEditorEvent;
    ...
    jsx(
      ...
      jsx(
        ...
        jsx(
          'div',
          __assign(
            { ref: divRef, css: styles, tabIndex: 0, onBlur: onBlur, onFocus: onFocus },
            ...
            jsx(
              ...
              jsx(
                ...
                jsx(AdaptiveDialog, {
                  ...
                  schema: __assign(__assign({}, schemaFromPlugins), customFlowSchema),
