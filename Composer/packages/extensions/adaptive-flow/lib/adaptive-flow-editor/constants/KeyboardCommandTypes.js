...
var _a = EditorConfig.features,
  arrowNavigation = _a.arrowNavigation,
  tabNavigation = _a.tabNavigation,
  keyboardNodeEditing = _a.keyboardNodeEditing,
  keyboardOperationEditing = _a.keyboardOperationEditing;
var SupportedShortcuts = __assign(
  __assign(
    __assign(
      __assign(__assign({}, BasicShortcuts), arrowNavigation ? ArrowMoveShortcuts : null),
