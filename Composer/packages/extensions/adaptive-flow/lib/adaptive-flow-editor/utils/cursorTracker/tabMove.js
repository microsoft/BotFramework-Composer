...
export function handleTabMove(currentElement, selectableElements, command) {
    ...
    var findElementWithSuffix = function (suffix) {
        return selectableElements.find(function (element) { return element.selectedId === "" + (selectableParent === null || selectableParent === void 0 ? void 0 : selectableParent.selectedId) + suffix; });
    };
