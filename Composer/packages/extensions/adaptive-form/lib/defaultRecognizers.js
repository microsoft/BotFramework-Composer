...
var DefaultRecognizers = [
  {
    ...
    displayName: function () {
      return format_message_1.default('Regular Expression');
    },
    ...
    renameIntent: function (intentName, newIntentName, shellData, shellApi) {
  ...
  },
  {
    ...
    displayName: function () {
      return format_message_1.default('Custom recognizer');
    },
    isSelected: function (data) {
