...
exports.AdaptiveForm = function AdaptiveForm(props) {
  ...
  if (!formData || !schema) {
    return core_1.jsx(
      LoadingTimeout_1.LoadingTimeout,
      { timeout: 2000 },
      core_1.jsx(
        'div',
        { css: styles.errorLoading },
        format_message_1.default('{type} could not be loaded', {
  ...
  return core_1.jsx(
    react_error_boundary_1.default,
    { FallbackComponent: ErrorInfo_1.default },
    core_1.jsx(FormTitle_1.default, {
      formData: formData,
      id: ((_a = formData.$designer) === null || _a === void 0 ? void 0 : _a.id) || 'unknown',
      schema: schema,
      uiOptions: uiOptions,
      onChange: function (newData) {
        return onChange(tslib_1.__assign(tslib_1.__assign({}, formData), newData));
      },
    }),
    core_1.jsx(SchemaField_1.SchemaField, {
      definitions: schema === null || schema === void 0 ? void 0 : schema.definitions,
      depth: -1,
      id: 'root',
      name: 'root',
      rawErrors: errors,
