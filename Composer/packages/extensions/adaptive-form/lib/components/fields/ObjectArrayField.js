...
var getNewPlaceholder = function (props, propertyName) {
  ...
  var placeholderOverride =
    (_b = (_a = uiOptions.properties) === null || _a === void 0 ? void 0 : _a[propertyName]) === null || _b === void 0
      ? void 0
      : _b.placeholder;
...
var ObjectArrayField = function (props) {
  ...
  var _b = react_1.useState({}),
    newObject = _b[0],
    setNewObject = _b[1];
  var _c = utils_1.useArrayItems(value, onChange),
    arrayItems = _c.arrayItems,
      ...
      if (Object.keys(newObject).length > 0) {
        var formattedData = Object.entries(newObject).reduce(function (obj, _a) {
          ...
          var serializeValue =
            (_f =
              (_d =
                (_c = uiOptions === null || uiOptions === void 0 ? void 0 : uiOptions.properties) === null ||
                _c === void 0
                  ? void 0
                  : _c[key]) === null || _d === void 0
                ? void 0
                : _d.serializer) === null || _f === void 0
              ? void 0
              : _f.set;
          return tslib_1.__assign(
            tslib_1.__assign({}, obj),
            ((_b = {}), (_b[key] = typeof serializeValue === 'function' ? serializeValue(value) : value), _b)
          );
        }, {});
  ...
  var orderedProperties = utils_1
    .getOrderedProperties(itemSchema && typeof itemSchema !== 'boolean' ? itemSchema : {}, uiOptions, value)
    .filter(function (property) {
      return Array.isArray(property) || !utils_1.isPropertyHidden(uiOptions, value, property);
    });
  var stackArrayItems = react_1.useMemo(
    function () {
      ...
      return (
        ...
        orderedProperties.some(function (property) {
  ...
  return core_1.jsx(
    ...
    core_1.jsx(
      ...
      orderedProperties.length > 1 &&
        ...
        core_1.jsx(
          'div',
          { css: styles_1.objectArrayField.objectItemLabel },
          orderedProperties.map(function (key, index) {
            if (typeof key === 'string') {
              ...
              if (propSchema && propSchema !== true) {
                return core_1.jsx(
                  'div',
                  { key: index, css: styles_1.objectArrayField.objectItemValueLabel },
                  core_1.jsx(FieldLabel_1.FieldLabel, {
                    inline: true,
      ...
      map_1.default(arrayItems, function (item, idx) {
        return core_1.jsx(
    ...
    core_1.jsx(
      'div',
      { css: styles_1.objectArrayField.inputFieldContainer },
      !stackArrayItems
        ? core_1.jsx(
            ...
            core_1.jsx(
              'div',
              { css: styles_1.objectArrayField.arrayItemField },
              orderedProperties
                .filter(function (p) {
                ...
                .map(function (property, index, allProperties) {
                  ...
                  if (typeof property === 'string') {
                    return core_1.jsx(
                      'div',
                      { key: index, css: styles_1.objectArrayField.objectItemInputField },
            ...
            core_1.jsx(
              ...
              { content: moreLabel },
              core_1.jsx(Button_2.IconButton, {
                disabled: true,
                ariaLabel: moreLabel,
