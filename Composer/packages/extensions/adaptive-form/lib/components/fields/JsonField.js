...
var fieldStyle = core_1.css(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n  max-height: 300px;\n\n  label: JsonField;\n"], ["\n  max-height: 300px;\n\n  label: JsonField;\n"])));
var JsonField = function (props) {
    var onChange = props.onChange, value = props.value, id = props.id, label = props.label, description = props.description, uiOptions = props.uiOptions, required = props.required, schema = props.schema;
    ...
    return (core_1.jsx(react_1.default.Fragment, null,
        ...
        core_1.jsx("div", { css: fieldStyle, "data-testid": "JsonFieldEditor" },
            core_1.jsx(code_editor_1.JsonEditor, { editorSettings: userSettings.codeEditor, height: 200, schema: schema, value: value, onChange: onChange }))));
};
