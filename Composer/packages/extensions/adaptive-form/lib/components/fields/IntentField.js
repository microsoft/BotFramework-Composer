...
var IntentField = function (props) {
  ...
  var recognizer = recognizers.find(function (r) {
    var _a;
    return r.isSelected(
  ...
  return react_1.default.createElement(
    ...
    Editor
      ? react_1.default.createElement(Editor, tslib_1.__assign({}, props, { onChange: handleChange }))
      : format_message_1.default('No Editor for {type}', {
          type: recognizer === null || recognizer === void 0 ? void 0 : recognizer.id,
        })
  );
};
