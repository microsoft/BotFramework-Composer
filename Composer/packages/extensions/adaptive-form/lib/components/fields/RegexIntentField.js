...
var RegexIntentField = function (_a) {
  var _b;
  var intentName = _a.value,
    rest = tslib_1.__rest(_a, ['value']);
  var _c = extension_1.useShellApi(),
    currentDialog = _c.currentDialog,
    shellApi = _c.shellApi;
  var _d = react_1.useState(getRegexIntentPattern(currentDialog, intentName)),
    localValue = _d[0],
    setLocalValue = _d[1];
  ...
  react_1.useEffect(
    ...
    [
      intentName,
      (_b = currentDialog.content.recognizer) === null || _b === void 0
        ? void 0
        : _b.intents.map(function (i) {
            return i.intent;
          }),
    ]
  );
  ...
  return core_1.jsx(
    ...
    tslib_1.__assign({}, rest, { label: false, value: localValue, onChange: handleIntentChange })
  );
};
