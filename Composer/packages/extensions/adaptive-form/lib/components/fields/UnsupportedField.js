...
exports.UnsupportedField = function UnsupportedField(props) {
  ...
  return core_1.jsx(
    ...
    core_1.jsx(
      'div',
      { css: styles_1.unsupportedField.container, 'data-testid': 'UnsupportedField' },
      props.label,
      ' (Unsupported Field)',
      core_1.jsx(
        Link_1.Link,
        {
          styles: styles_1.unsupportedField.link,
          onClick: function () {
    ...
    core_1.jsx(
      'pre',
      { css: styles_1.unsupportedField.details(!showDetails), 'data-testid': 'UnsupportedFieldDetails' },
      'props: ',
