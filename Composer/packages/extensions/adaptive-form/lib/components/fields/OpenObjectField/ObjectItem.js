...
var ObjectItem = function (_a) {
  var definitions = _a.definitions,
    originalName = _a.name,
    formData = _a.formData,
    value = _a.value,
    stackedLayout = _a.stackedLayout,
    schema = _a.schema,
  ...
  var initialName = react_1.useMemo(function () {
    return originalName;
  }, []);
  var initialValue = react_1.useMemo(function () {
    return value;
  }, []);
  var _b = react_1.useState(originalName),
    name = _b[0],
    setName = _b[1];
  ...
  var handleBlur = react_1.useCallback(
    function () {
      if (!name || name === '') {
  ...
  var placeholder =
    schema.type === 'string' || !schema.type ? initialValue || format_message_1.default('Add a new value') : undefined;
  return core_1.jsx(
    'div',
    { css: styles_1.container, 'data-testid': 'ObjectItem' },
    core_1.jsx(
      'div',
      { css: styles_1.itemContainer(stackedLayout) },
      core_1.jsx(
        'div',
        { css: styles_1.item },
        core_1.jsx(StringField_1.StringField, {
          definitions: definitions,
          depth: 0,
          error: errorMessage,
          id: name + '.key',
          label: stackedLayout ? format_message_1.default('Key') : false,
          name: 'key',
          placeholder: initialName || format_message_1.default('Add a new key'),
          schema: {},
