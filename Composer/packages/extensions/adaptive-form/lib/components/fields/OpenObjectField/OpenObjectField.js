...
var OpenObjectField = function (props) {
  ...
  var _d = objectUtils_1.useObjectItems(value, onChange),
    addProperty = _d.addProperty,
    objectEntries = _d.objectEntries,
    handleChange = _d.onChange;
        ...
        tslib_1.__assign(
          {
            ...
            uiOptions: ((_b = uiOptions.properties) === null || _b === void 0 ? void 0 : _b.additionalProperties) || {},
            value: propertyValue,
          },
          objectUtils_1.getPropertyItemProps(objectEntries, index, handleChange)
        )
      );
    }),
        ...
        ? core_1.jsx(
            ...
            core_1.jsx(
              ...
              core_1.jsx(TextField_1.TextField, {
                ...
                placeholder: format_message_1.default('Add a new key'),
                styles: {
            ...
            core_1.jsx(
              ...
              core_1.jsx(TextField_1.TextField, {
                ...
                placeholder: format_message_1.default('Add a new value'),
                styles: {
                  root: { margin: '7px 0 7px 0' },
                },
                value: newValue,
