...
exports.SelectField = function SelectField(props) {
  ...
  var options = react_1.useMemo(
    function () {
      var opts = (enumOptions !== null && enumOptions !== void 0 ? enumOptions : []).map(function (o) {
        return {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(Dropdown_1.Dropdown, {
      ariaLabel: label || format_message_1.default('selection field'),
