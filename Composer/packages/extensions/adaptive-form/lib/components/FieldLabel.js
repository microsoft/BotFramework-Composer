...
var DescriptionCallout = function DescriptionCallout(props) {
  ...
  return core_1.jsx(
    ...
    {
      delay: Tooltip_1.TooltipDelay.zero,
      directionalHint: Tooltip_1.DirectionalHint.bottomAutoEdge,
      ...
      tooltipProps: {
        ...
        onRenderContent: function () {
          return core_1.jsx(
            ...
            core_1.jsx(
              'h3',
              { 'aria-label': title + '.', style: { fontSize: '20px', margin: '0', marginBottom: '10px' } },
              title
            ),
            ...
            helpLink &&
              core_1.jsx(
                Link_1.Link,
                {
                  'aria-label': format_message_1.default('Learn more about {title}', { title: title.toLowerCase() }),
                  href: helpLink,
    ...
    core_1.jsx(
      'div',
      { css: sharedStyles_1.focusBorder, 'data-testid': 'FieldLabelDescriptionIcon', tabIndex: 0 },
      core_1.jsx(Icon_1.Icon, {
