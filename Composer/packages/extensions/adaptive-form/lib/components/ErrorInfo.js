...
var ErrorInfo = function (_a) {
    ...
    return (react_1.default.createElement("div", { style: { marginRight: '20px' } },
        react_1.default.createElement(MessageBar_1.MessageBar, { isMultiline: false, messageBarType: MessageBar_1.MessageBarType.error },
            react_1.default.createElement("p", { style: { whiteSpace: 'pre-wrap' } },
                react_1.default.createElement("strong", null, format_message_1.default({ default: 'An error occured in the form editor!', id: 'ErrorInfo_part1' })),
                ...
                react_1.default.createElement("br", null),
                format_message_1.default({ default: 'Try navigating to another node in the visual editor.', id: 'ErrorInfo_part3' })),
