...
var SchemaField = function (props) {
  ...
  var handleChange = function (newValue) {
    var _a;
    var serializedValue =
      typeof ((_a = uiOptions === null || uiOptions === void 0 ? void 0 : uiOptions.serializer) === null ||
      _a === void 0
        ? void 0
        : _a.set) === 'function'
  ...
  var error =
    ...
    core_1.jsx(ErrorMessage_1.ErrorMessage, {
      error: rawErrors,
      helpLink: uiOptions.helpLink,
      label: utils_1.getUiLabel(props),
    });
  var deserializedValue =
    typeof ((_a = uiOptions === null || uiOptions === void 0 ? void 0 : uiOptions.serializer) === null || _a === void 0
      ? void 0
      : _a.get) === 'function'
      ? uiOptions.serializer.get(value)
      : value;
  var FieldWidget = utils_1.resolveFieldWidget(schema, uiOptions, formUIOptions);
  var fieldProps = tslib_1.__assign(tslib_1.__assign({}, rest), {
    definitions: definitions,
    description: utils_1.getUiDescription(tslib_1.__assign(tslib_1.__assign({}, props), { uiOptions: uiOptions })),
    enumOptions: schema.enum,
    error: error || undefined,
    label: utils_1.getUiLabel(tslib_1.__assign(tslib_1.__assign({}, props), { uiOptions: uiOptions })),
    name: name,
    onChange: handleChange,
    placeholder: utils_1.getUiPlaceholder(tslib_1.__assign(tslib_1.__assign({}, props), { uiOptions: uiOptions })),
    rawErrors:
      typeof (rawErrors === null || rawErrors === void 0 ? void 0 : rawErrors[name]) === 'object'
        ? rawErrors === null || rawErrors === void 0
          ? void 0
          : rawErrors[name]
        : rawErrors,
    schema: schema,
  ...
  return core_1.jsx(
    'div',
    { className: className, css: schemaField.container(props.depth) },
