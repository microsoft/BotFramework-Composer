...
var container = core_2.css(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n"], ["\n  height: 100%;\n  width: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n"])));
var LoadingTimeout = function (props) {
    var children = props.children, _a = props.timeout, timeout = _a === void 0 ? 1000 : _a;
    var _b = react_1.useState(false), showFallback = _b[0], setShowFallback = _b[1];
    ...
    return showFallback ? (core_1.jsx("div", null, children)) : (core_1.jsx("div", { css: container },
