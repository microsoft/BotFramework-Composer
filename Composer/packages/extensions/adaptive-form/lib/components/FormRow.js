...
exports.getRowProps = function (rowProps, field) {
  ...
  var id = rowProps.id,
    ...
    definitions = rowProps.definitions,
    value = rowProps.value,
    uiOptions = rowProps.uiOptions,
    transparentBorder = rowProps.transparentBorder,
    className = rowProps.className,
    label = rowProps.label,
    rawErrors = rowProps.rawErrors,
    onBlur = rowProps.onBlur,
    onFocus = rowProps.onFocus,
    onChange = rowProps.onChange;
  var _c = schema.required,
    required = _c === void 0 ? [] : _c;
  ...
  var newUiOptions =
    (_b = (_a = uiOptions.properties) === null || _a === void 0 ? void 0 : _a[field]) !== null && _b !== void 0
      ? _b
      : {};
...
var FormRow = function (props) {
  ...
  if (Array.isArray(row)) {
    return core_1.jsx(
      'div',
      { css: formRow.row },
      row.map(function (property) {
        return core_1.jsx(
          SchemaField_1.SchemaField,
          tslib_1.__assign({ key: id + '.' + property, css: formRow.property }, exports.getRowProps(props, property))
        );
      })
    );
  }
  return core_1.jsx(
    SchemaField_1.SchemaField,
    tslib_1.__assign({ key: id + '.' + row, css: formRow.full }, exports.getRowProps(props, row))
  );
};
