...
var styles = {
    transition: core_1.css(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n    transition: height 300ms cubic-bezier(0.4, 0, 0.2, 1);\n    overflow: hidden;\n  "], ["\n    transition: height 300ms cubic-bezier(0.4, 0, 0.2, 1);\n    overflow: hidden;\n  "]))),
    header: core_1.css(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n    display: flex;\n    margin: 0 8px;\n    align-items: center;\n  "], ["\n    display: flex;\n    margin: 0 8px;\n    align-items: center;\n  "]))),
};
exports.CollapseField = function (_a) {
    var children = _a.children, defaultCollapsed = _a.defaultCollapsed, label = _a.label;
    var _b = react_1.useState(!!defaultCollapsed), isOpen = _b[0], setIsOpen = _b[1];
    return (core_1.jsx(react_1.Fragment, null,
        core_1.jsx("div", { "data-is-focusable": true, "aria-expanded": isOpen, "aria-label": typeof label === 'string' ? label : format_message_1.default('Field Set'), css: styles.header, role: "presentation", onClick: function () {
                setIsOpen(!isOpen);
            } },
            core_1.jsx(Button_1.IconButton, { iconProps: { iconName: isOpen ? 'ChevronDown' : 'ChevronRight' }, styles: { root: { color: fluent_theme_1.NeutralColors.gray150 } } }),
        ...
        core_1.jsx("div", null,
            core_1.jsx(CollapseContent, { isOpen: isOpen }, children))));
};
...
var CollapseContent = function (_a) {
    var className = _a.className, children = _a.children, collapseHeight = _a.collapseHeight, isOpen = _a.isOpen, layoutEffect = _a.layoutEffect, render = _a.render, transition = _a.transition, onChange = _a.onChange, onInit = _a.onInit, attrs = tslib_1.__rest(_a, ["className", "children", "collapseHeight", "isOpen", "layoutEffect", "render", "transition", "onChange", "onInit"]);
    var contentRef = react_1.useRef(null);
    var _b = react_1.useState(isOpen ? EXPANDED : COLLAPSED), collapseState = _b[0], setCollapseState = _b[1];
    var _c = react_1.useState({
        height: isOpen ? null : getCollapseHeight(),
        visibility: isOpen ? null : getCollapsedVisibility(),
    }), collapseStyle = _c[0], setCollapseStyle = _c[1];
    var _d = react_1.useState(false), hasReversed = _d[0], setHasReversed = _d[1];
    ...
    function onTransitionEnd(_a) {
        var target = _a.target, propertyName = _a.propertyName;
    ...
    return (core_1.jsx("div", tslib_1.__assign({ ref: contentRef, className: className, css: styles.transition, style: style, onTransitionEnd: onTransitionEnd }, attrs), typeof render === 'function' ? render(collapseState) : children));
};
function nextFrame(callback) {
    // Ensure it is always visible on collapsing, afterFrame didn't work
    requestAnimationFrame(function () { return requestAnimationFrame(callback); });
}
