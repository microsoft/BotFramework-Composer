...
function resolveFieldWidget(schema, uiOptions, globalUIOptions) {
    ...
    if (schema) {
        ...
        if (globalUIOptions) {
            var KindOverride = schema.$kind && ((_a = globalUIOptions[schema.$kind]) === null || _a === void 0 ? void 0 : _a.field);
            if (KindOverride) {
                return KindOverride;
            }
        }
        ...
        if ((_b = uiOptions === null || uiOptions === void 0 ? void 0 : uiOptions.intellisenseScopes) === null || _b === void 0 ? void 0 : _b.length) {
