...
function resolveRef(schema, definitions) {
    ...
    if (typeof (schema === null || schema === void 0 ? void 0 : schema.$ref) === 'string') {
        if (!((_a = schema === null || schema === void 0 ? void 0 : schema.$ref) === null || _a === void 0 ? void 0 : _a.startsWith('#/definitions/'))) {
            return schema;
        }
        ...
        var _b = schema.items, $ref = _b.$ref, rest = tslib_1.__rest(_b, ["$ref"]);
        var items = resolveRef(schema.items, definitions);
        var resolvedSchema = tslib_1.__assign(tslib_1.__assign({}, schema), { items: tslib_1.__assign(tslib_1.__assign({}, items), rest) });
        return resolvedSchema;
    }
    return schema;
}
