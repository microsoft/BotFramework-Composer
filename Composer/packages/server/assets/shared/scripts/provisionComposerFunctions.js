...
const templatePath = path.join(__dirname, 'DeploymentTemplates', 'function-template-with-preexisting-rg.json');
...
const create = async (
  ...
  appId,
  appPassword,
  createLuisResource = false, //ccastro made false
  createLuisAuthoringResource = false, //ccastro made false
  createCosmosDb = true,
  createStorage = true,
