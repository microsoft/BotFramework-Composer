...
// provision
router.get('/provision/:projectId/status/:target/:jobId', ProvisionController.getProvisionStatus);
router.get('/provision/:projectId/status/:target', ProvisionController.getProvisionStatus);
