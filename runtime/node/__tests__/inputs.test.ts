...
const samplesDirectory = path.resolve(
  __dirname,
  '../../../extensions/samples/assets/projects',
...
const getProjectRoot = jest.spyOn(helpers, 'getProjectRoot').mockImplementation(() => samplesDirectory);
const getSettings = jest.spyOn(helpers, 'getSettings').mockImplementation((root: string) => {
