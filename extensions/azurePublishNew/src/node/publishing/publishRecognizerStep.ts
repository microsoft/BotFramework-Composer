...
export const publishRecognizerStep = async (config: StepConfig, onProgress: OnPublishProgress): Promise<StepResult> => {
  ...
  const region = luisConfig.region || 'westus';

  const {
    //TODO: Move the defaults up the stack
    authoringKey: luisAuthoringKey,
    authoringEndpoint: authoringEndpoint = `https://${region}.api.cognitive.microsoft.com`,
    authoringRegion: luisAuthoringRegion = region,
  } = luisConfig;
